(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=o(s);fetch(s.href,n)}})();const b=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let y=[],x=null;function fe(e){x=e}function ue(e){y.length=0,e.forEach(t=>y.push(t))}const bt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function I(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function V(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of bt)if(e>=t)return o;return"Unwatchable"}function J(e){let t=0,o=0;for(const i of b)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function re(){y.forEach(e=>{e.total=J(e.scores)})}function G(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function le(){if(!x||!x.weights)return;const e=x.weights;b.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),re()}let L={key:"total",dir:"desc"},Se="grid";const wt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Exec"},{key:"acting",label:"Acting"},{key:"production",label:"Prod"},{key:"enjoyability",label:"Enjoy"},{key:"rewatchability",label:"Rewatch"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Unique"}];function kt(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function $t(){const{key:e,dir:t}=L;return e==="rank"||e==="total"?[...y].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...y].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...y].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Re(e){Se=e,q()}function He(e){L.key===e?L.dir=L.dir==="desc"?"asc":"desc":(L.key=e,L.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=L.dir==="desc"?"↓":"↑")}q()}function q(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(y.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    ${e.map((n,a)=>{const r=s==="total"?n.total:n.scores?.[s]??null,c=r!=null?s==="total"?(Math.round(r*10)/10).toFixed(1):r:"—",l=kt(r),p=n.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${n.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${y.indexOf(n)})">
        <div class="film-card-poster-wrap">
          ${p}
          <div class="film-card-rank">${a+1}</div>
          <div class="film-card-score ${l}">${c}</div>
        </div>
  ...
  </div>`}function Et(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Fe("table"));const s=[...y].sort((a,r)=>r.total-a.total),n=new Map(s.map((a,r)=>[a.title,r+1]));t.innerHTML=e.map(a=>{const r=a.scores,c=n.get(a.title),l=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",p=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${y.indexOf(a)})">
      ...
      <div class="film-total">${l}</div>
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,w=B?O:t.scores,g=B?J(O):t.total,m=b.map(d=>{const v=w[d.key],k=n[d.key];return B?`<div class="breakdown-row" style="align-items:center;gap:12px">
    ...
    <div style="margin-bottom:20px">
      ...
      ${c?`<div style="margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);margin-right:8px">Wri.</span>${c}</div>`:""}
    ...
    <div>${m}</div>
    ${!B&&s.length>0?`<div class="compare-section">
      <div class="compare-title">Nearby in the rankings</div>
      ${s.map(d=>{const v=(d.total-t.total).toFixed(2),k=v>0?"+":"";return`<div class="compare-film" style="cursor:pointer" onclick="closeModal();openModal(${y.indexOf(d)})">
  ...
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e),B||Lt(t)}window.modalEnterEdit=function(){const e=y[ge];B=!0,O={...e.scores},ve()};window.modalCancelEdit=function(){B=!1,O={},ve()};window.modalUpdateScore=function(e,t){O[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${G(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=be(parseInt(t)));const s=J(O),n=document.getElementById("modal-total-display");n&&(n.textContent=s);const a=document.getElementById("modal-total-label");a&&(a.textContent=be(s))};window.modalSaveScores=function(){const e=y[ge];e.scores={...O},e.total=J(O),B=!1,O={},re(),F(),q(),Ie().catch(t=>console.warn("sync failed",t)),ve()};async function Lt(e){const t=document.getElementById("modal-insight");if(t)try{const{getFilmInsight:o}=await _(async()=>{const{getFilmInsight:s}=await import("./insights-tJ2JZeK0.js");return{getFilmInsight:s}},[]),i=await o(e);if(!document.getElementById("modal-insight"))return;t.innerHTML=`
      ...
      </div>`}catch{const i=document.getElementById("modal-insight");i&&(i.style.display="none")}}function jt(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}let U="directors";function R(e){return I((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Pt(e){const t={};return y.forEach(o=>{let i=[];e==="directors"?i=R(o.director):e==="writers"?i=R(o.writer):e==="actors"?i=R(o.cast):e==="companies"?i=R(o.productionCompanies):e==="years"&&(i=o.year?[String(o.year)]:[]),i.forEach(s=>{t[s]||(t[s]=[]),t[s].push(o)})}),t}function Ge(e){const t=Pt(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((s,n)=>s+n.total,0)/i.length).toFixed(1)),catAvgs:b.reduce((s,n)=>{const a=i.filter(r=>r.scores[n.key]!=null).map(r=>r.scores[n.key]);return s[n.key]=a.length?parseFloat((a.reduce((r,c)=>r+c,0)/a.length).toFixed(1)):null,s},{})})).sort((o,i)=>i.avg-o.avg)}function Je(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.55)"}function _e(e){e&&(U=e);const t=["directors","writers","actors","companies","years"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Production Co.",years:"Years"},i=Ge(U),s=document.getElementById("explore-section");s&&(s.innerHTML=`
  ...
  `)}function Ot(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(m=>m.classList.remove("active")),document.getElementById("analysis").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(m=>m.classList.remove("active"));const o=document.querySelector('.nav-btn[onclick*="analysis"]');o&&o.classList.add("active"),window.scrollTo(0,0);const i=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":e==="year"?"years":"companies";U=i;const s=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":e==="year"?"Year":"Production Co.",n=y.filter(m=>e==="director"?R(m.director).includes(t):e==="writer"?R(m.writer).includes(t):e==="actor"?R(m.cast).includes(t):e==="company"?R(m.productionCompanies).includes(t):e==="year"?String(m.year)===t:!1).sort((m,d)=>d.total-m.total);if(n.length===0){_e();return}const a=Ge(i),r=a.findIndex(m=>m.name===t)+1,c=a.length,l=a.find(m=>m.name===t),p=l?l.avg.toFixed(1):(n.reduce((m,d)=>m+d.total,0)/n.length).toFixed(1);n[0];const f={};b.forEach(m=>{const d=a.filter(k=>k.catAvgs[m.key]!=null).sort((k,E)=>E.catAvgs[m.key]-k.catAvgs[m.key]),v=d.findIndex(k=>k.name===t)+1;f[m.key]=v>0?{rank:v,total:d.length}:null});const g=b.map(m=>{const d=n.filter(v=>v.scores[m.key]!=null).map(v=>v.scores[m.key]);return{...m,avg:d.length?parseFloat((d.reduce((v,k)=>v+k,0)/d.length).toFixed(1)):null}}).filter(m=>m.avg!=null).sort((m,d)=>d.avg-m.avg);g[0],g[g.length-1],document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:800px">
      ...
      ${n.map((m,d)=>{const v=m.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${m.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',k=m.total!=null?(Math.round(m.total*10)/10).toFixed(1):"—";return`
  ...
  `,qt(e,t,n)}async function qt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:s}=await _(async()=>{const{getEntityInsight:a}=await import("./insights-tJ2JZeK0.js");return{getEntityInsight:a}},[]),n=await s(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
...
Respond with this exact JSON structure:
{
  ...
  `}window.undoCalChoice=function(){if(ne.length===0)return;const e=ne.pop();T=e.idx,A=e.tempScores,S=e.deltas,Ce()};window.calChoose=function(e){if(ne.push({idx:T,tempScores:JSON.parse(JSON.stringify(A)),deltas:JSON.parse(JSON.stringify(S))}),e!=="skip"){const{a:t,b:o,catKey:i}=W[T],s=A[t.title]?.[i]??t.scores[i],n=A[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(n-s)/40)),r=1-a,c=e==="a"?1:0,l=1-c,p=Math.round(Math.min(100,Math.max(1,s+qe*(c-a)))),f=Math.round(Math.min(100,Math.max(1,n+qe*(l-r))));if(S[t.title]||(S[t.title]={}),S[o.title]||(S[o.title]={}),p!==s){const m=S[t.title][i]?.old??s;S[t.title][i]={old:m,new:p},A[t.title][i]=p}if(f!==n){const m=S[o.title][i]?.old??n;S[o.title][i]={old:m,new:f},A[o.title][i]=f}const w=document.getElementById(`cal-card-${e}`),g=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);w&&(w.style.opacity="1"),g&&(g.style.opacity="0.35",g.style.transform="scale(0.97)")}T++,setTimeout(()=>Ce(),e==="skip"?0:140)};function Zt(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(S).flatMap(([o,i])=>Object.entries(i).map(([s,{old:n,new:a}])=>({title:o,catKey:s,old:n,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
  ...
  `}function Te(){const e=document.getElementById("profileContent");if(!e)return;const t=x;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=Z[t.archetype]||{},i=t.weights||{},s=o.weights||null,n=y,a=C.map(l=>{const p=n.filter(f=>f.scores?.[l]!=null);return{c:l,avg:p.length?p.reduce((f,w)=>f+w.scores[l],0)/p.length:0}}),r=n.length?[...a].sort((l,p)=>p.avg-l.avg)[0]:null,c=n.length?(n.reduce((l,p)=>l+p.total,0)/n.length).toFixed(1):"—";e.innerHTML=`
