(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=o(s);fetch(s.href,n)}})();const b=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let y=[],x=null;function fe(e){x=e}function ue(e){y.length=0,e.forEach(t=>y.push(t))}const bt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function A(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function V(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of bt)if(e>=t)return o;return"Unwatchable"}function J(e){let t=0,o=0;for(const i of b)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function re(){y.forEach(e=>{e.total=J(e.scores)})}function G(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function le(){if(!x||!x.weights)return;const e=x.weights;b.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),re()}let L={key:"total",dir:"desc"},Se="grid";const wt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Exec"},{key:"acting",label:"Acting"},{key:"production",label:"Prod"},{key:"enjoyability",label:"Enjoy"},{key:"rewatchability",label:"Rewatch"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Unique"}];function kt(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function $t(){const{key:e,dir:t}=L;return e==="rank"||e==="total"?[...y].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...y].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...y].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Re(e){Se=e,q()}function He(e){L.key===e?L.dir=L.dir==="desc"?"asc":"desc":(L.key=e,L.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=L.dir==="desc"?"↓":"↑")}q()}function q(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(y.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
  ...
  </div>`}function Mt(e,t,o,i){i.classList.add("grid-mode"),o&&(o.innerHTML=Fe("grid"));const s=["total","rank","title"].includes(L.key)?"total":L.key;t.innerHTML=`<div class="film-grid">
    ${e.map((n,a)=>{const r=s==="total"?n.total:n.scores?.[s]??null,d=r!=null?s==="total"?(Math.round(r*10)/10).toFixed(1):r:"—",l=kt(r),p=n.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${n.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${y.indexOf(n)})">
        <div class="film-card-poster-wrap">
          ${p}
          <div class="film-card-rank">${a+1}</div>
          <div class="film-card-score ${l}">${d}</div>
        </div>
        <div class="film-card-meta">
          <div class="film-card-title">${n.title}</div>
          <div class="film-card-sub">${n.year||""}${n.director?" · "+n.director.split(",")[0]:""}</div>
        </div>
      </div>`}).join("")}
  </div>`}function Et(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Fe("table"));const s=[...y].sort((a,r)=>r.total-a.total),n=new Map(s.map((a,r)=>[a.title,r+1]));t.innerHTML=e.map(a=>{const r=a.scores,d=n.get(a.title),l=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",p=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${y.indexOf(a)})">
      ...
      <div class="film-total">${l}</div>
    </div>`}).join("")}const St=Object.freeze(Object.defineProperty({__proto__:null,renderRankings:q,setViewMode:Re,sortBy:He},Symbol.toStringTag,{value:"Module"})),It="modulepreload",Dt=function(e){return"/"+e},je={},I=function(t,o,i){let s=Promise.resolve();if(o&&o.length>0){let d=function(l){return Promise.all(l.map(p=>Promise.resolve(p).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),r=a?.nonce||a?.getAttribute("nonce");s=d(o.map(l=>{if(l=Dt(l),l in je)return;je[l]=!0;const p=l.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${f}`))return;const w=document.createElement("link");if(w.rel=p?"stylesheet":It,p||(w.as="script"),w.crossOrigin="",w.href=l,r&&w.setAttribute("nonce",r),document.head.appendChild(w),p)return new Promise((g,m)=>{w.addEventListener("load",g),w.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return s.then(a=>{for(const r of a||[])r.status==="rejected"&&n(r.reason);return t().catch(n)})},Pe="palate_migrations_v1";function _t(){let e;try{e=JSON.parse(localStorage.getItem(Pe)||"{}")}catch{e={}}if(!e.fix_split_names){let t=0;y.forEach(o=>{const i=A((o.cast||"").split(",").map(n=>n.trim()).filter(Boolean)).join(", ");i!==(o.cast||"")&&(o.cast=i,t++);const s=A((o.productionCompanies||"").split(",").map(n=>n.trim()).filter(Boolean)).join(", ");s!==(o.productionCompanies||"")&&(o.productionCompanies=s,t++)}),t>0&&(F(),console.log(`Migration fix_split_names: repaired ${t} fields.`)),e.fix_split_names=!0;try{localStorage.setItem(Pe,JSON.stringify(e))}catch{}}}const Ue="filmRankings_v1";function F(){try{localStorage.setItem(Ue,JSON.stringify(y))}catch(e){console.warn("localStorage save failed:",e)}x&&(clearTimeout(F._syncTimer),F._syncTimer=setTimeout(()=>{I(()=>Promise.resolve().then(()=>Ve),void 0).then(e=>e.syncToSupabase())},2e3))}function Ct(){try{const e=localStorage.getItem(Ue);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;ue(t),console.log(`Loaded ${y.length} films from localStorage`)}catch(e){console.warn("localStorage load failed:",e)}}const Bt="https://gzuuhjjedrzeqbgxhfip.supabase.co",Tt="sb_publishable_OprjtxkrwknRf8jSZ7bYWg_GGqRiu4z",ye=window.supabase.createClient(Bt,Tt);async function Ie(){const e=x;if(!e)return;const{setCloudStatus:t}=await I(async()=>{const{setCloudStatus:o}=await Promise.resolve().then(()=>ee);return{setCloudStatus:o}},void 0);t("syncing");try{const{error:o}=await ye.from("ledger_users").upsert({id:e.id,username:e.username,display_name:e.display_name,archetype:e.archetype,archetype_secondary:e.archetype_secondary,weights:e.weights,harmony_sensitivity:e.harmony_sensitivity||.3,movies:y,updated_at:new Date().toISOString()},{onConflict:"id"});if(o)throw o;t("synced"),ce()}catch(o){console.warn("Supabase sync error:",JSON.stringify(o)),t("error")}}async function We(e){const{setCloudStatus:t,updateMastheadProfile:o,updateStorageStatus:i}=await I(async()=>{const{setCloudStatus:n,updateMastheadProfile:a,updateStorageStatus:r}=await Promise.resolve().then(()=>ee);return{setCloudStatus:n,updateMastheadProfile:a,updateStorageStatus:r}},void 0),{renderRankings:s}=await I(async()=>{const{renderRankings:n}=await Promise.resolve().then(()=>St);return{renderRankings:n}},void 0);t("syncing");try{const{data:n,error:a}=await ye.from("ledger_users").select("*").eq("id",e).single();if(a)throw a;n&&(fe({id:n.id,username:n.username,display_name:n.display_name,archetype:n.archetype,archetype_secondary:n.archetype_secondary,weights:n.weights,harmony_sensitivity:n.harmony_sensitivity}),n.movies&&Array.isArray(n.movies)&&n.movies.length>=y.length&&ue(n.movies),ce(),le(),t("synced"),o(),s(),i())}catch(n){console.warn("Supabase load error:",n),t("error")}}function ce(){try{localStorage.setItem("ledger_user",JSON.stringify(x))}catch{}}function Ye(){try{const e=localStorage.getItem("ledger_user");e&&fe(JSON.parse(e))}catch{}}const Ve=Object.freeze(Object.defineProperty({__proto__:null,loadFromSupabase:We,loadUserLocally:Ye,saveUserLocally:ce,sb:ye,syncToSupabase:Ie},Symbol.toStringTag,{value:"Module"})),At=[[90,"All-time favorite"],[85,"Really exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch"],[0,"Unwatchable"]];function be(e){for(const[t,o]of At)if(e>=t)return o;return"Unwatchable"}let ge=null,C=!1,O={};function zt(e){ge=e,C=!1,O={},ve()}function ve(){const e=ge,t=y[e],o=[...y].sort((c,v)=>v.total-c.total),i=o.indexOf(t)+1,s=o.filter(c=>c!==t&&Math.abs(c.total-t.total)<6).slice(0,5),n={};b.forEach(c=>{const v=[...y].sort((k,E)=>(E.scores[c.key]||0)-(k.scores[c.key]||0));n[c.key]=v.indexOf(t)+1});const a=(c,v,k)=>`<span class="modal-meta-chip" onclick="exploreEntity('${v}','${k.replace(/'/g,"'")}')">${c}</span>`,r=A((t.director||"").split(",").map(c=>c.trim()).filter(Boolean)).map(c=>a(c,"director",c)).join(""),d=A((t.writer||"").split(",").map(c=>c.trim()).filter(Boolean)).map(c=>a(c,"writer",c)).join(""),l=A((t.cast||"").split(",").map(c=>c.trim()).filter(Boolean)).map(c=>a(c,"actor",c)).join(""),p=A((t.productionCompanies||"").split(",").map(c=>c.trim()).filter(Boolean)).map(c=>a(c,"company",c)).join(""),f=t.poster?`<div style="position:relative;display:flex;align-items:stretch;background:var(--surface-dark);margin:-40px -40px 28px;padding:28px 32px">
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,w=C?O:t.scores,g=C?J(O):t.total,m=b.map(c=>{const v=w[c.key],k=n[c.key];return C?`<div class="breakdown-row" style="align-items:center;gap:12px">
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;min-width:60px">
          <div class="breakdown-val ${G(v||50)}" id="modal-edit-val-${c.key}">${v||50}</div>
          <div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim);text-align:right;margin-top:2px;white-space:nowrap" id="modal-edit-lbl-${c.key}">${be(v||50)}</div>
        </div>
    ...
    <div style="margin-bottom:20px">
      ...
      ${l?`<div style="margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);margin-right:8px">Cast</span><div style="display:inline">${l}</div></div>`:""}
    ...
    <div>${m}</div>
    ${!C&&s.length>0?`<div class="compare-section">
      <div class="compare-title">Nearby in the rankings</div>
      ${s.map(c=>{const v=(c.total-t.total).toFixed(2),k=v>0?"+":"";return`<div class="compare-film" style="cursor:pointer" onclick="closeModal();openModal(${y.indexOf(c)})">
  ...
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e),C||Lt(t)}window.modalEnterEdit=function(){const e=y[ge];C=!0,O={...e.scores},ve()};window.modalCancelEdit=function(){C=!1,O={},ve()};window.modalUpdateScore=function(e,t){O[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${G(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=be(parseInt(t)));const s=J(O),n=document.getElementById("modal-total-display");n&&(n.textContent=s);const a=document.getElementById("modal-total-label");a&&(a.textContent=be(s))};window.modalSaveScores=function(){const e=y[ge];e.scores={...O},e.total=J(O),C=!1,O={},re(),F(),q(),Ie().catch(t=>console.warn("sync failed",t)),ve()};async function Lt(e){const t=document.getElementById("modal-insight");if(t)try{const{getFilmInsight:o}=await I(async()=>{const{getFilmInsight:s}=await import("./insights-CyLbEjGm.js");return{getFilmInsight:s}},[]),i=await o(e);if(!document.getElementById("modal-insight"))return;t.innerHTML=`
      ...
      </div>`}catch{const i=document.getElementById("modal-insight");i&&(i.style.display="none")}}function jt(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}let U="directors";function R(e){return A((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Pt(e){const t={};return y.forEach(o=>{let i=[];e==="directors"?i=R(o.director):e==="writers"?i=R(o.writer):e==="actors"?i=R(o.cast):e==="companies"?i=R(o.productionCompanies):e==="years"&&(i=o.year?[String(o.year)]:[]),i.forEach(s=>{t[s]||(t[s]=[]),t[s].push(o)})}),t}function Ge(e){const t=Pt(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((s,n)=>s+n.total,0)/i.length).toFixed(1)),catAvgs:b.reduce((s,n)=>{const a=i.filter(r=>r.scores[n.key]!=null).map(r=>r.scores[n.key]);return s[n.key]=a.length?parseFloat((a.reduce((r,d)=>r+d,0)/a.length).toFixed(1)):null,s},{})})).sort((o,i)=>i.avg-o.avg)}function Je(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.55)"}function De(e){e&&(U=e);const t=["directors","writers","actors","companies","years"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Production Co.",years:"Years"},i=Ge(U),s=document.getElementById("explore-section");s&&(s.innerHTML=`
    <div class="explore-tabs" style="margin-bottom:24px">
      ${t.map(n=>`<button class="explore-tab ${n===U?"active":""}" onclick="renderExploreIndex('${n}')">${o[n]}</button>`).join("")}
    </div>
    ${i.length===0?`<div style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim);font-style:italic;padding:48px 0">Not enough data yet — add more films to see patterns.</div>`:i.map((n,a)=>{const r=n.name.replace(/'/g,"\\'");return`<div style="display:flex;align-items:center;gap:16px;padding:14px 0;border-bottom:1px solid var(--rule);cursor:pointer" onclick="exploreEntity('${U==="companies"?"company":U==="years"?"year":U.slice(0,-1)}','${r}')" onmouseover="this.style.background='var(--cream)'" onmouseout="this.style.background=''">
  ...
  `)}function Ot(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(m=>m.classList.remove("active")),document.getElementById("analysis").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(m=>m.classList.remove("active"));const o=document.querySelector('.nav-btn[onclick*="analysis"]');o&&o.classList.add("active"),window.scrollTo(0,0);const i=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":e==="year"?"years":"companies";U=i;const s=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":e==="year"?"Year":"Production Co.",n=y.filter(m=>e==="director"?R(m.director).includes(t):e==="writer"?R(m.writer).includes(t):e==="actor"?R(m.cast).includes(t):e==="company"?R(m.productionCompanies).includes(t):e==="year"?String(m.year)===t:!1).sort((m,c)=>c.total-m.total);if(n.length===0){De();return}const a=Ge(i),r=a.findIndex(m=>m.name===t)+1,d=a.length,l=a.find(m=>m.name===t),p=l?l.avg.toFixed(1):(n.reduce((m,c)=>m+c.total,0)/n.length).toFixed(1);n[0];const f={};b.forEach(m=>{const c=a.filter(k=>k.catAvgs[m.key]!=null).sort((k,E)=>E.catAvgs[m.key]-k.catAvgs[m.key]),v=c.findIndex(k=>k.name===t)+1;f[m.key]=v>0?{rank:v,total:c.length}:null});const g=b.map(m=>{const c=n.filter(v=>v.scores[m.key]!=null).map(v=>v.scores[m.key]);return{...m,avg:c.length?parseFloat((c.reduce((v,k)=>v+k,0)/c.length).toFixed(1)):null}}).filter(m=>m.avg!=null).sort((m,c)=>c.avg-m.avg);g[0],g[g.length-1],document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:800px">
      ...
      ${g.length>0?`
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 40px;margin-bottom:32px">
          ${g.map(m=>{const c=f[m.key];return`<div style="border-bottom:1px solid var(--rule);padding:10px 0">
              <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:6px">
                ...
                <div style="display:flex;align-items:baseline;gap:8px">
                  ${c?`<div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim)">#${c.rank}</div>`:""}
      ...
      ${n.map((m,c)=>{const v=m.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${m.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',k=m.total!=null?(Math.round(m.total*10)/10).toFixed(1):"—";return`
        <div class="film-row" onclick="openModal(${y.indexOf(m)})" style="cursor:pointer">
          <div class="film-poster-cell">${v}</div>
          <div class="film-rank">${c+1}</div>
          <div class="film-title-cell">
  ...
  `,qt(e,t,n)}async function qt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:s}=await I(async()=>{const{getEntityInsight:a}=await import("./insights-CyLbEjGm.js");return{getEntityInsight:a}},[]),n=await s(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
      ...
      </div>`}catch{const n=document.getElementById("explore-insight");n&&(n.style.display="none")}}function _e(){const e=i=>i.length?Math.round(i.reduce((s,n)=>s+n,0)/i.length*100)/100:null,t=b.map(i=>{const s=y.map(n=>n.scores[i.key]).filter(n=>n!=null);return{...i,avg:e(s)}});function o(i){return i>=90?"#C4922A":i>=80?"#1F4A2A":i>=70?"#4A5830":i>=60?"#6B4820":"rgba(12,11,9,0.65)"}document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:900px">
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px 40px">
          ${t.filter(i=>i.avg!=null&&!isNaN(i.avg)).map(i=>{const s=Math.round(i.avg),n=o(i.avg);return`
            <div style="display:flex;align-items:center;gap:12px;padding:6px 0">
              ...
              <div style="flex:1;height:2px;background:var(--rule);position:relative;overflow:hidden">
                <div style="position:absolute;top:0;left:0;height:100%;background:${n};width:${s}%"></div>
              </div>
  ...
  `,De()}const we="f5a446a5f70a9f6a16a8ddd052c121f2",ke="https://api.themoviedb.org/3",Nt="https://ledger-proxy.noahparikhcott.workers.dev";let Oe=null,Q=null,$e=null;function Ke(){document.getElementById("predict-search").value="",document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-result").innerHTML="",Q=null,setTimeout(()=>document.getElementById("predict-search")?.focus(),50)}function Rt(){clearTimeout(Oe),Oe=setTimeout(Qe,500)}async function Qe(){const e=document.getElementById("predict-search").value.trim();if(!e||e.length<2)return;const t=document.getElementById("predict-search-results");t.innerHTML='<div class="tmdb-loading">Searching…</div>';try{const s=((await(await fetch(`${ke}/search/movie?api_key=${we}&query=${encodeURIComponent(e)}&language=en-US&page=1`)).json()).results||[]).slice(0,5);if(!s.length){t.innerHTML='<div class="tmdb-error">No results found.</div>';return}const n=new Set(y.map(a=>a.title.toLowerCase()));t.innerHTML=s.map(a=>{const r=a.release_date?.slice(0,4)||"",d=a.poster_path?`<img class="tmdb-result-poster" src="https://image.tmdb.org/t/p/w92${a.poster_path}">`:'<div class="tmdb-result-poster-placeholder">no img</div>',l=n.has(a.title.toLowerCase());return`<div class="tmdb-result ${l?"opacity-50":""}" onclick="${l?"":`predictSelectFilm(${a.id}, '${a.title.replace(/'/g,"\\'")}', '${r}')`}" style="${l?"opacity:0.4;cursor:default":""}">
    ...
    </div>`;let i={},s={};try{const[f,w]=await Promise.all([fetch(`${ke}/movie/${e}?api_key=${we}`),fetch(`${ke}/movie/${e}/credits?api_key=${we}`)]);i=await f.json(),s=await w.json()}catch{}const n=(s.crew||[]).filter(f=>f.job==="Director").map(f=>f.name).join(", "),a=(s.crew||[]).filter(f=>["Screenplay","Writer","Story"].includes(f.job)).map(f=>f.name).slice(0,2).join(", "),r=(s.cast||[]).slice(0,8).map(f=>f.name).join(", "),d=(i.genres||[]).map(f=>f.name).join(", "),l=i.overview||"",p=i.poster_path||null;Q={tmdbId:e,title:t,year:o,director:n,writer:a,cast:r,genres:d,overview:l,poster:p},await Wt(Q)}function Ft(){const e=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],t={};e.forEach(a=>{const r=y.filter(p=>p.scores[a]!=null).map(p=>p.scores[a]);if(!r.length){t[a]={mean:70,std:10,min:0,max:100};return}const d=r.reduce((p,f)=>p+f,0)/r.length,l=Math.sqrt(r.reduce((p,f)=>p+(f-d)**2,0)/r.length);t[a]={mean:Math.round(d*10)/10,std:Math.round(l*10)/10,min:Math.min(...r),max:Math.max(...r)}});const o=[...y].sort((a,r)=>r.total-a.total),i=o.slice(0,10).map(a=>`${a.title} (${a.total})`).join(", "),s=o.slice(-5).map(a=>`${a.title} (${a.total})`).join(", "),n=b.map(a=>`${a.label}×${a.weight}`).join(", ");return{stats:t,top10:i,bottom5:s,weightStr:n,archetype:x?.archetype,archetypeSecondary:x?.archetype_secondary,totalFilms:y.length}}function Ut(e){const t=A((e.director||"").split(",").map(i=>i.trim()).filter(Boolean)),o=A((e.cast||"").split(",").map(i=>i.trim()).filter(Boolean));return y.filter(i=>{const s=A((i.director||"").split(",").map(a=>a.trim()).filter(Boolean)),n=A((i.cast||"").split(",").map(a=>a.trim()).filter(Boolean));return t.some(a=>s.includes(a))||o.some(a=>n.includes(a))}).sort((i,s)=>s.total-i.total).slice(0,8)}async function Wt(e){const t=Ft(),o=Ut(e),i=o.length?o.map(r=>`- ${r.title} (${r.year||""}): total=${r.total}, plot=${r.scores.plot}, execution=${r.scores.execution}, acting=${r.scores.acting}, production=${r.scores.production}, enjoyability=${r.scores.enjoyability}, rewatchability=${r.scores.rewatchability}, ending=${r.scores.ending}, uniqueness=${r.scores.uniqueness}`).join(`
...
Respond with this exact JSON structure:
{
  ...
  "key_comparables": ["<film title>", "<film title>"]
}`;try{const p=((await(await fetch(Nt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:n,messages:[{role:"user",content:a}]})})).json()).content?.[0]?.text||"").replace(/```json|```/g,"").trim(),f=JSON.parse(p);$e=f,Yt(e,f,o)}catch(r){document.getElementById("predict-result").innerHTML=`
      <div class="tmdb-error">Prediction failed: ${r.message}. Check that the proxy is running and your API key is valid.</div>`}}function Yt(e,t,o){let i=0,s=0;b.forEach(l=>{const p=t.predicted_scores[l.key];p!=null&&(i+=p*l.weight,s+=l.weight)});const n=s>0?Math.round(i/s*100)/100:0,a=e.poster?`<img class="predict-poster" src="https://image.tmdb.org/t/p/w185${e.poster}" alt="${e.title}">`:`<div class="predict-poster-placeholder">${e.title}</div>`,r={high:"conf-high",medium:"conf-medium",low:"conf-low"}[t.confidence]||"conf-medium",d={high:"High confidence",medium:"Medium confidence",low:"Low confidence"}[t.confidence]||"";document.getElementById("predict-result").innerHTML=`
    ...
    <div class="predict-score-grid">
      ${b.map(l=>{const p=t.predicted_scores[l.key];return`<div class="predict-score-cell">
    ...
    ${o.length>0?`
      ...
      ${o.slice(0,5).map(l=>{const p=(n-l.total).toFixed(1),f=p>0?"+":"";return`<div class="predict-comp-row" onclick="openModal(${y.indexOf(l)})">
  ...
  `}function Vt(){Q&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=Q.title,I(()=>Promise.resolve().then(()=>mo),void 0).then(t=>{$e?.predicted_scores&&t.prefillWithPrediction($e.predicted_scores),t.liveSearch(Q.title)}))},100))}let te="all",Xe="focused",W=[],B=0,S={},T={},ne=[];const Gt={focused:15,thorough:30,deep:50},qe=8;function Jt(e){te=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function Kt(e){Xe=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Qt(e,t){const o=[];(e==="all"?b.map(a=>a.key):[e]).forEach(a=>{const r=y.filter(d=>d.scores[a]!=null).sort((d,l)=>d.scores[a]-l.scores[a]);for(let d=0;d<r.length-1;d++)for(let l=d+1;l<r.length;l++){const p=Math.abs(r[d].scores[a]-r[l].scores[a]);if(p<=8)o.push({a:r[d],b:r[l],catKey:a,diff:p});else break}}),o.sort((a,r)=>a.diff-r.diff);const s=new Set,n=[];for(const a of o){const r=[a.a.title,a.b.title,a.catKey].join("|");s.has(r)||(s.add(r),n.push(a))}return n.sort(()=>Math.random()-.5).slice(0,t)}function Xt(){const e=Gt[Xe];if(W=Qt(te,e),W.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}B=0,S={},T={},ne=[],y.forEach(t=>{T[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=te==="all"?"All categories":b.find(t=>t.key===te)?.label||te,Ce()}function Ce(){if(B>=W.length){Zt();return}const{a:e,b:t,catKey:o}=W[B],i=W.length,s=Math.round(B/i*100);document.getElementById("cal-progress-label").textContent=`${B+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=s+"%";const n=b.find(d=>d.key===o)?.label||o;T[e.title]?.[o]??e.scores[o],T[t.title]?.[o]??t.scores[o];function a(d,l){const p=d.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${d.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
  ...
  `}window.undoCalChoice=function(){if(ne.length===0)return;const e=ne.pop();B=e.idx,T=e.tempScores,S=e.deltas,Ce()};window.calChoose=function(e){if(ne.push({idx:B,tempScores:JSON.parse(JSON.stringify(T)),deltas:JSON.parse(JSON.stringify(S))}),e!=="skip"){const{a:t,b:o,catKey:i}=W[B],s=T[t.title]?.[i]??t.scores[i],n=T[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(n-s)/40)),r=1-a,d=e==="a"?1:0,l=1-d,p=Math.round(Math.min(100,Math.max(1,s+qe*(d-a)))),f=Math.round(Math.min(100,Math.max(1,n+qe*(l-r))));if(S[t.title]||(S[t.title]={}),S[o.title]||(S[o.title]={}),p!==s){const m=S[t.title][i]?.old??s;S[t.title][i]={old:m,new:p},T[t.title][i]=p}if(f!==n){const m=S[o.title][i]?.old??n;S[o.title][i]={old:m,new:f},T[o.title][i]=f}const w=document.getElementById(`cal-card-${e}`),g=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);w&&(w.style.opacity="1"),g&&(g.style.opacity="0.35",g.style.transform="scale(0.97)")}B++,setTimeout(()=>Ce(),e==="skip"?0:140)};function Zt(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(S).flatMap(([o,i])=>Object.entries(i).map(([s,{old:n,new:a}])=>({title:o,catKey:s,old:n,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
      ${b.map(o=>{const i=t[o.key],s=i.slice(0,3),n=i.length-3,a=i.length>0;return`<div style="padding:14px;background:var(--cream);border-radius:6px;${a?"":"opacity:0.45"}">
          ...
          ${s.map((r,d)=>{const l=r.new>r.old?"var(--green)":"var(--red)";return`<div style="display:flex;align-items:center;gap:8px;padding:5px 0;${d<s.length-1?"border-bottom:1px solid var(--rule)":""}">
  ...
  </div>`}function at(e){Y[e].checked=!Y[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(Y[e].checked?"checked":"unchecked")}function rt(){se=null,document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function lt(){const e=u._allDirectors||[],t=u._allWriters||[],o=Object.values(z).filter(s=>s.checked).map(s=>s.actor.name),i=Object.values(Y).filter(s=>s.checked).map(s=>s.company.name);u.title=u._tmdbDetail.title,u.director=e.join(", "),u.writer=t.join(", "),u.cast=o.join(", "),u.productionCompanies=i.join(", "),lo(),de(2)}let se=null;function ao(e){se=e}function ro(e){const t=[...y].filter(n=>n.scores[e]!=null).sort((n,a)=>a.scores[e]-n.scores[e]),o=t.length,i=[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean),s=new Set;return i.filter(n=>s.has(n.title)?!1:(s.add(n.title),!0))}function lo(){const e=document.getElementById("calibrationCategories");e.innerHTML=b.map(t=>{const o=ro(t.key),i=se?.[t.key]??u.scores[t.key]??50;return`<div class="category-section" id="catSection_${t.key}">
    ...
    </div>`}).join(""),b.forEach(t=>{u.scores[t.key]=se?.[t.key]??u.scores[t.key]??50})}window.selectAnchor=function(e,t,o){o.closest(".anchor-row").querySelectorAll(".anchor-film").forEach(n=>n.classList.remove("selected")),o.classList.add("selected");const i=u.scores[e]??50,s=Math.round((i+t)/2);document.getElementById("slider_"+e).value=s,updateSlider(e,s)};window.updateSlider=function(e,t){t=parseInt(t),u.scores[e]=t,document.getElementById("sliderVal_"+e).textContent=t,document.getElementById("sliderDesc_"+e).textContent=V(t)};function ct(){co(),de(3)}let H=[],P=0,ae=[];function co(){H=[],ae=[],b.forEach(e=>{const t=u.scores[e.key];if(!t)return;y.filter(i=>i.scores[e.key]!=null&&Math.abs(i.scores[e.key]-t)<=3).sort((i,s)=>Math.abs(i.scores[e.key]-t)-Math.abs(s.scores[e.key]-t)).slice(0,1).forEach(i=>H.push({cat:e,film:i}))}),H=H.slice(0,6),P=0,xe()}function xe(){const e=document.getElementById("hthContainer");if(H.length===0||P>=H.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:var(--dim);font-style:italic">
  ...
  `}function pt(){u.total=J(u.scores),y.push({title:u.title,year:u.year,total:u.total,director:u.director,writer:u.writer,cast:u.cast,productionCompanies:u.productionCompanies||"",poster:u._tmdbDetail?.poster_path||null,overview:u._tmdbDetail?.overview||"",scores:{...u.scores}}),F(),I(()=>Promise.resolve().then(()=>ee),void 0).then(e=>e.updateStorageStatus()),u={title:"",year:null,director:"",writer:"",cast:"",productionCompanies:"",scores:{}},z={},Y={},oe=[],se=null,document.getElementById("f-search").value="",document.getElementById("tmdb-results").innerHTML="",document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("moreCastBtn").style.display="",de(1),q(),document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("rankings").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelectorAll(".nav-btn")[0].classList.add("active")}const mo=Object.freeze(Object.defineProperty({__proto__:null,confirmTmdbData:lt,goToStep:et,goToStep3:ct,goToStep4:dt,liveSearch:tt,prefillWithPrediction:ao,resetToSearch:rt,saveFilm:pt,showMoreCast:st,tmdbSelect:ot,toggleCast:nt,toggleCompany:at},Symbol.toStringTag,{value:"Module"}));function fo(){if(!x){I(()=>Promise.resolve().then(()=>no),void 0).then(e=>e.launchOnboarding());return}mt()}function mt(){if(!x)return;const e=x.weights||{},t=Math.max(...Object.values(e));document.getElementById("archetypeModalContent").innerHTML=`
    ...
    <div id="archetype-weights-form">
      ${b.map(o=>{const i=e[o.key]||1,s=Math.round(i/t*100);return`<div class="archetype-weight-row">
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function ft(e,t){const o=b.map(s=>({key:s.key,val:parseFloat(document.getElementById("awval_"+s.key)?.value)||1})),i=Math.max(...o.map(s=>s.val));o.forEach(s=>{const n=document.getElementById("awbar_"+s.key);n&&(n.style.width=Math.round(s.val/i*100)+"%")})}function uo(){if(!x||!x.archetype)return;const e=Z[x.archetype]?.weights;e&&(b.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),ft())}function yo(){const e={};b.forEach(t=>{const o=parseFloat(document.getElementById("awval_"+t.key)?.value);e[t.key]=isNaN(o)||o<1?1:Math.min(10,o)}),x.weights=e,I(()=>Promise.resolve().then(()=>Ve),void 0).then(t=>t.saveUserLocally()),le(),q(),F(),ut()}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function ut(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}const _=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],yt={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},go={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function vo(e,t,o=220){const i=_.length,s=o/2,n=o/2,a=o*.36,r=$=>$/i*Math.PI*2-Math.PI/2,d=($,D)=>({x:s+a*D*Math.cos(r($)),y:n+a*D*Math.sin(r($))}),l=[.25,.5,.75,1].map($=>`<polygon points="${_.map((M,K)=>`${d(K,$).x},${d(K,$).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),p=_.map(($,D)=>{const M=d(D,1);return`<line x1="${s}" y1="${n}" x2="${M.x}" y2="${M.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),f=Math.max(..._.map($=>e[$]||1)),g=`<polygon points="${_.map(($,D)=>{const M=d(D,(e[$]||1)/f);return`${M.x},${M.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let m="";if(t){const $=Math.max(..._.map(M=>t[M]||1));m=`<polygon points="${_.map((M,K)=>{const Le=d(K,(t[M]||1)/$);return`${Le.x},${Le.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const c=_.map(($,D)=>{const M=d(D,(e[$]||1)/f);return`<circle cx="${M.x}" cy="${M.y}" r="2.5" fill="var(--blue)"/>`}).join(""),v=22,k=_.map(($,D)=>{const M=d(D,1+v/a),K=M.x<s-5?"end":M.x>s+5?"start":"middle";return`<text x="${M.x}" y="${M.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${K}" dominant-baseline="middle">${go[$]}</text>`}).join(""),E=36;return`<svg width="${o+E*2}" height="${o+E*2}" viewBox="${-E} ${-E} ${o+E*2} ${o+E*2}" style="overflow:visible;display:block">
    ${l}${p}${m}${g}${c}${k}
  </svg>`}function ho(e){return e.length?_.map(t=>{const o=e.filter(a=>a.scores?.[t]!=null),i=o.length?o.reduce((a,r)=>a+r.scores[t],0)/o.length:null,s=i!=null?i.toFixed(1):"—",n=i??0;return`<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
  ...
  `}function Te(){const e=document.getElementById("profileContent");if(!e)return;const t=x;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=Z[t.archetype]||{},i=t.weights||{},s=o.weights||null,n=y,a=_.map(l=>{const p=n.filter(f=>f.scores?.[l]!=null);return{c:l,avg:p.length?p.reduce((f,w)=>f+w.scores[l],0)/p.length:0}}),r=n.length?[...a].sort((l,p)=>p.avg-l.avg)[0]:null,d=n.length?(n.reduce((l,p)=>l+p.total,0)/n.length).toFixed(1):"—";e.innerHTML=`
