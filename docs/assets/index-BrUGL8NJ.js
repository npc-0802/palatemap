(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const w=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let y=[],x=null;function fe(e){x=e}function ue(e){y.length=0,e.forEach(t=>y.push(t))}const bt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[15,"So bad I stopped watching"],[10,"Disgusting"],[2,"Insulting"],[0,"Unwatchable"]];function I(e){const t=[];let o=0;for(;o<e.length;)!e[o].includes(" ")&&e[o+1]&&!e[o+1].includes(" ")?(t.push(e[o]+" "+e[o+1]),o+=2):(t.push(e[o]),o++);return t}function V(e){if(e===100)return"No better exists";if(e===1)return"No worse exists";for(const[t,o]of bt)if(e>=t)return o;return"Unwatchable"}function J(e){let t=0,o=0;for(const i of w)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function re(){y.forEach(e=>{e.total=J(e.scores)})}function G(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function le(){if(!x||!x.weights)return;const e=x.weights;w.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),re()}let L={key:"total",dir:"desc"},Se="grid";const wt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Execution"},{key:"acting",label:"Acting"},{key:"production",label:"Production"},{key:"enjoyability",label:"Enjoyability"},{key:"rewatchability",label:"Rewatchability"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Uniqueness"}];function kt(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function $t(){const{key:e,dir:t}=L;return e==="rank"||e==="total"?[...y].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...y].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...y].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Ne(e){Se=e,q()}function He(e){L.key===e?L.dir=L.dir==="desc"?"asc":"desc":(L.key=e,L.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=L.dir==="desc"?"↓":"↑")}q()}function q(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(y.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
  ...
  </div>`}function Mt(e,t,o,i){i.classList.add("grid-mode"),o&&(o.innerHTML=Fe("grid"));const n=["total","rank","title"].includes(L.key)?"total":L.key,s=[...y].sort((r,c)=>c.total-r.total),a=new Map(s.map((r,c)=>[r.title,c+1]));t.innerHTML=`<div class="film-grid">
    ${e.map(r=>{const c=n==="total"?r.total:r.scores?.[n]??null,l=c!=null?n==="total"?(Math.round(c*10)/10).toFixed(1):c:"—",p=kt(c),f=r.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${r.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${y.indexOf(r)})">
        <div class="film-card-poster-wrap">
          ${f}
          <div class="film-card-rank">${a.get(r.title)}</div>
          <div class="film-card-score ${p}">${l}</div>
        </div>
  ...
  </div>`}function Et(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Fe("table"));const n=[...y].sort((a,r)=>r.total-a.total),s=new Map(n.map((a,r)=>[a.title,r+1]));t.innerHTML=e.map(a=>{const r=a.scores,c=s.get(a.title),l=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",p=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${y.indexOf(a)})">
      ...
      <div class="film-total">${l}</div>
    </div>`}).join("")}const St=Object.freeze(Object.defineProperty({__proto__:null,renderRankings:q,setViewMode:Ne,sortBy:He},Symbol.toStringTag,{value:"Module"})),It="modulepreload",Dt=function(e){return"/"+e},je={},D=function(t,o,i){let n=Promise.resolve();if(o&&o.length>0){let c=function(l){return Promise.all(l.map(p=>Promise.resolve(p).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),r=a?.nonce||a?.getAttribute("nonce");n=c(o.map(l=>{if(l=Dt(l),l in je)return;je[l]=!0;const p=l.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${f}`))return;const b=document.createElement("link");if(b.rel=p?"stylesheet":It,p||(b.as="script"),b.crossOrigin="",b.href=l,r&&b.setAttribute("nonce",r),document.head.appendChild(b),p)return new Promise((g,m)=>{b.addEventListener("load",g),b.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return n.then(a=>{for(const r of a||[])r.status==="rejected"&&s(r.reason);return t().catch(s)})},Pe="palate_migrations_v1";function _t(){let e;try{e=JSON.parse(localStorage.getItem(Pe)||"{}")}catch{e={}}if(!e.fix_split_names){let t=0;y.forEach(o=>{const i=I((o.cast||"").split(",").map(s=>s.trim()).filter(Boolean)).join(", ");i!==(o.cast||"")&&(o.cast=i,t++);const n=I((o.productionCompanies||"").split(",").map(s=>s.trim()).filter(Boolean)).join(", ");n!==(o.productionCompanies||"")&&(o.productionCompanies=n,t++)}),t>0&&(U(),console.log(`Migration fix_split_names: repaired ${t} fields.`)),e.fix_split_names=!0;try{localStorage.setItem(Pe,JSON.stringify(e))}catch{}}}const Ue="filmRankings_v1";function U(){try{localStorage.setItem(Ue,JSON.stringify(y))}catch(e){console.warn("localStorage save failed:",e)}x&&(clearTimeout(U._syncTimer),U._syncTimer=setTimeout(()=>{D(()=>Promise.resolve().then(()=>Ve),void 0).then(e=>e.syncToSupabase())},2e3))}function Ct(){try{const e=localStorage.getItem(Ue);if(!e)return;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return;ue(t),console.log(`Loaded ${y.length} films from localStorage`)}catch(e){console.warn("localStorage load failed:",e)}}const Bt="https://gzuuhjjedrzeqbgxhfip.supabase.co",Tt="sb_publishable_OprjtxkrwknRf8jSZ7bYWg_GGqRiu4z",ye=window.supabase.createClient(Bt,Tt);async function Ie(){const e=x;if(!e)return;const{setCloudStatus:t}=await D(async()=>{const{setCloudStatus:o}=await Promise.resolve().then(()=>ee);return{setCloudStatus:o}},void 0);t("syncing");try{const{error:o}=await ye.from("ledger_users").upsert({id:e.id,username:e.username,display_name:e.display_name,archetype:e.archetype,archetype_secondary:e.archetype_secondary,weights:e.weights,harmony_sensitivity:e.harmony_sensitivity||.3,movies:y,updated_at:new Date().toISOString()},{onConflict:"id"});if(o)throw o;t("synced"),ce()}catch(o){console.warn("Supabase sync error:",JSON.stringify(o)),t("error")}}async function We(e){const{setCloudStatus:t,updateMastheadProfile:o,updateStorageStatus:i}=await D(async()=>{const{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:r}=await Promise.resolve().then(()=>ee);return{setCloudStatus:s,updateMastheadProfile:a,updateStorageStatus:r}},void 0),{renderRankings:n}=await D(async()=>{const{renderRankings:s}=await Promise.resolve().then(()=>St);return{renderRankings:s}},void 0);t("syncing");try{const{data:s,error:a}=await ye.from("ledger_users").select("*").eq("id",e).single();if(a)throw a;if(s){if(fe({id:s.id,username:s.username,display_name:s.display_name,archetype:s.archetype,archetype_secondary:s.archetype_secondary,weights:s.weights,harmony_sensitivity:s.harmony_sensitivity}),s.movies&&Array.isArray(s.movies)&&s.movies.length>=y.length){const r=s.movies.map(c=>({...c,cast:I((c.cast||"").split(",").map(l=>l.trim()).filter(Boolean)).join(", "),productionCompanies:I((c.productionCompanies||"").split(",").map(l=>l.trim()).filter(Boolean)).join(", ")}));ue(r)}ce(),le(),t("synced"),o(),n(),i()}}catch(s){console.warn("Supabase load error:",s),t("error")}}function ce(){try{localStorage.setItem("ledger_user",JSON.stringify(x))}catch{}}function Ye(){try{const e=localStorage.getItem("ledger_user");e&&fe(JSON.parse(e))}catch{}}const Ve=Object.freeze(Object.defineProperty({__proto__:null,loadFromSupabase:We,loadUserLocally:Ye,saveUserLocally:ce,sb:ye,syncToSupabase:Ie},Symbol.toStringTag,{value:"Module"})),At=[[90,"All-time favorite"],[85,"Really exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch"],[0,"Unwatchable"]];function be(e){for(const[t,o]of At)if(e>=t)return o;return"Unwatchable"}let ge=null,B=!1,O={};function zt(e){ge=e,B=!1,O={},ve()}function ve(){const e=ge,t=y[e],o=[...y].sort((d,v)=>v.total-d.total),i=o.indexOf(t)+1,n=o.filter(d=>d!==t&&Math.abs(d.total-t.total)<6).slice(0,5),s={};w.forEach(d=>{const v=[...y].sort((k,E)=>(E.scores[d.key]||0)-(k.scores[d.key]||0));s[d.key]=v.indexOf(t)+1});const a=(d,v,k)=>`<span class="modal-meta-chip" onclick="exploreEntity('${v}','${k.replace(/'/g,"'")}')">${d}</span>`,r=I((t.director||"").split(",").map(d=>d.trim()).filter(Boolean)).map(d=>a(d,"director",d)).join(""),c=I((t.writer||"").split(",").map(d=>d.trim()).filter(Boolean)).map(d=>a(d,"writer",d)).join(""),l=I((t.cast||"").split(",").map(d=>d.trim()).filter(Boolean)).map(d=>a(d,"actor",d)).join(""),p=I((t.productionCompanies||"").split(",").map(d=>d.trim()).filter(Boolean)).map(d=>a(d,"company",d)).join(""),f=t.poster?`<div class="dark-grid" style="position:relative;display:flex;align-items:stretch;background:var(--surface-dark);margin:-40px -40px 28px;padding:28px 32px">
         ...
         <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:clamp(20px,3.5vw,30px);line-height:1.1;color:var(--on-dark);letter-spacing:-0.5px;margin-bottom:8px">${t.title}</div>
         <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--on-dark-dim)">${t.year||""}</div>
       </div>`,b=B?O:t.scores,g=B?J(O):t.total,m=w.map(d=>{const v=b[d.key],k=s[d.key];return B?`<div class="breakdown-row" style="align-items:center;gap:12px">
    ...
    <div style="margin-bottom:20px">
      ...
      ${c?`<div style="display:flex;align-items:flex-start;gap:8px;margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);min-width:44px;flex-shrink:0;padding-top:5px">Wri.</span><div style="display:flex;flex-wrap:wrap;gap:4px">${c}</div></div>`:""}
      ${l?`<div style="display:flex;align-items:flex-start;gap:8px;margin-bottom:8px"><span style="font-family:'DM Mono',monospace;font-size:9px;text-transform:uppercase;letter-spacing:1px;color:var(--dim);min-width:44px;flex-shrink:0;padding-top:5px">Cast</span><div style="display:flex;flex-wrap:wrap;gap:4px">${l}</div></div>`:""}
  ...
  `,document.getElementById("filmModal").classList.add("open"),localStorage.setItem("ledger_last_modal",e),B||Lt(t)}window.modalEnterEdit=function(){const e=y[ge];B=!0,O={...e.scores},ve()};window.modalCancelEdit=function(){B=!1,O={},ve()};window.modalUpdateScore=function(e,t){O[e]=parseInt(t);const o=document.getElementById(`modal-edit-val-${e}`);o&&(o.textContent=t,o.className=`breakdown-val ${G(parseInt(t))}`);const i=document.getElementById(`modal-edit-lbl-${e}`);i&&(i.textContent=be(parseInt(t)));const n=J(O),s=document.getElementById("modal-total-display");s&&(s.textContent=n);const a=document.getElementById("modal-total-label");a&&(a.textContent=be(n))};window.modalSaveScores=function(){const e=y[ge];e.scores={...O},e.total=J(O),B=!1,O={},re(),U(),q(),Ie().catch(t=>console.warn("sync failed",t)),ve()};async function Lt(e){const t=document.getElementById("modal-insight");if(t)try{const{getFilmInsight:o}=await D(async()=>{const{getFilmInsight:n}=await import("./insights-D_7Y1SWL.js");return{getFilmInsight:n}},[]),i=await o(e);if(!document.getElementById("modal-insight"))return;t.innerHTML=`
      ...
      </div>`}catch{const i=document.getElementById("modal-insight");i&&(i.style.display="none")}}function jt(e){(!e||e.target===document.getElementById("filmModal"))&&document.getElementById("filmModal").classList.remove("open")}let R="directors";function H(e){return I((e||"").split(",").map(t=>t.trim()).filter(Boolean))}function Pt(e){const t={};return y.forEach(o=>{let i=[];e==="directors"?i=H(o.director):e==="writers"?i=H(o.writer):e==="actors"?i=H(o.cast):e==="companies"?i=H(o.productionCompanies):e==="years"&&(i=o.year?[String(o.year)]:[]),i.forEach(n=>{t[n]||(t[n]=[]),t[n].push(o)})}),t}function Ge(e){const t=Pt(e);return Object.entries(t).filter(([,o])=>o.length>=2).map(([o,i])=>({name:o,films:i,avg:parseFloat((i.reduce((n,s)=>n+s.total,0)/i.length).toFixed(1)),catAvgs:w.reduce((n,s)=>{const a=i.filter(r=>r.scores[s.key]!=null).map(r=>r.scores[s.key]);return n[s.key]=a.length?parseFloat((a.reduce((r,c)=>r+c,0)/a.length).toFixed(1)):null,n},{})})).sort((o,i)=>i.avg-o.avg)}function Je(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.55)"}function De(e){e&&(R=e);const t=["directors","writers","actors","companies","years"],o={directors:"Directors",writers:"Writers",actors:"Actors",companies:"Production Co.",years:"Years"},i=Ge(R),n=document.getElementById("explore-section");n&&(n.innerHTML=`
    <div class="explore-tabs" style="margin-bottom:24px">
      ${t.map(s=>`<button class="explore-tab ${s===R?"active":""}" onclick="renderExploreIndex('${s}')">${o[s]}</button>`).join("")}
    </div>
    ${i.length===0?`<div style="border:1.5px dashed var(--rule-dark);padding:40px 32px;text-align:center;margin:8px 0">
        ...
        </div>`:i.map((s,a)=>{const r=s.name.replace(/'/g,"\\'");return`<div style="display:flex;align-items:center;gap:16px;padding:14px 0;border-bottom:1px solid var(--rule);cursor:pointer" onclick="exploreEntity('${R==="companies"?"company":R==="years"?"year":R.slice(0,-1)}','${r}')" onmouseover="this.style.background='var(--cream)'" onmouseout="this.style.background=''">
  ...
  `)}function Ot(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(m=>m.classList.remove("active")),document.getElementById("analysis").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(m=>m.classList.remove("active"));const o=document.querySelector('.nav-btn[onclick*="analysis"]');o&&o.classList.add("active"),window.scrollTo(0,0);const i=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":e==="year"?"years":"companies";R=i;const n=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":e==="year"?"Year":"Production Co.",s=y.filter(m=>e==="director"?H(m.director).includes(t):e==="writer"?H(m.writer).includes(t):e==="actor"?H(m.cast).includes(t):e==="company"?H(m.productionCompanies).includes(t):e==="year"?String(m.year)===t:!1).sort((m,d)=>d.total-m.total);if(s.length===0){De();return}const a=Ge(i),r=a.findIndex(m=>m.name===t)+1,c=a.length,l=a.find(m=>m.name===t),p=l?l.avg.toFixed(1):(s.reduce((m,d)=>m+d.total,0)/s.length).toFixed(1);s[0];const f={};w.forEach(m=>{const d=a.filter(k=>k.catAvgs[m.key]!=null).sort((k,E)=>E.catAvgs[m.key]-k.catAvgs[m.key]),v=d.findIndex(k=>k.name===t)+1;f[m.key]=v>0?{rank:v,total:d.length}:null});const g=w.map(m=>{const d=s.filter(v=>v.scores[m.key]!=null).map(v=>v.scores[m.key]);return{...m,avg:d.length?parseFloat((d.reduce((v,k)=>v+k,0)/d.length).toFixed(1)):null}}).filter(m=>m.avg!=null).sort((m,d)=>d.avg-m.avg);g[0],g[g.length-1],document.getElementById("analysisContent").innerHTML=`
  ...
  `,qt(e,t,s)}async function qt(e,t,o){const i=document.getElementById("explore-insight");if(i)try{const{getEntityInsight:n}=await D(async()=>{const{getEntityInsight:a}=await import("./insights-D_7Y1SWL.js");return{getEntityInsight:a}},[]),s=await n(e,t,o);if(!document.getElementById("explore-insight"))return;i.innerHTML=`
      ...
      </div>`}catch{const s=document.getElementById("explore-insight");s&&(s.style.display="none")}}function _e(){const e=i=>i.length?Math.round(i.reduce((n,s)=>n+s,0)/i.length*100)/100:null,t=w.map(i=>{const n=y.map(s=>s.scores[i.key]).filter(s=>s!=null);return{...i,avg:e(n)}});function o(i){return i>=90?"#C4922A":i>=80?"#1F4A2A":i>=70?"#4A5830":i>=60?"#6B4820":"rgba(12,11,9,0.65)"}document.getElementById("analysisContent").innerHTML=`
    <div style="max-width:900px">
      ...
      <div style="margin-bottom:40px;padding-bottom:32px;border-bottom:1px solid var(--rule)">
        ...
        ${(()=>{const i=["plot","execution","acting","production"],n=["enjoyability","rewatchability","ending","uniqueness"],s=t.filter(l=>l.avg!=null&&!isNaN(l.avg)),a=s.filter(l=>i.includes(l.key)),r=s.filter(l=>n.includes(l.key));function c(l,p){return p.length?`
              <div style="margin-bottom:24px">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:6px 40px">
                  ${p.map(f=>{const b=Math.round(f.avg),g=o(f.avg);return`<div style="display:flex;align-items:center;gap:12px;padding:6px 0">
                      <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);width:88px;flex-shrink:0">${f.label}</div>
                      ...
                      <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:var(--ink);width:36px;text-align:right;letter-spacing:-0.5px">${f.avg}</div>
                    </div>`}).join("")}
                </div>
...
Respond with this exact JSON structure:
{
  ...
  "key_comparables": ["<film title>", "<film title>"]
}`;try{const p=((await(await fetch(Rt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:s,messages:[{role:"user",content:a}]})})).json()).content?.[0]?.text||"").replace(/```json|```/g,"").trim(),f=JSON.parse(p);$e=f,Yt(e,f,o)}catch(r){document.getElementById("predict-result").innerHTML=`
      <div class="tmdb-error">Prediction failed: ${r.message}. Check that the proxy is running and your API key is valid.</div>`}}function Yt(e,t,o){let i=0,n=0;w.forEach(l=>{const p=t.predicted_scores[l.key];p!=null&&(i+=p*l.weight,n+=l.weight)});const s=n>0?Math.round(i/n*100)/100:0,a=e.poster?`<img class="predict-poster" src="https://image.tmdb.org/t/p/w185${e.poster}" alt="${e.title}">`:`<div class="predict-poster-placeholder">${e.title}</div>`,r={high:"conf-high",medium:"conf-medium",low:"conf-low"}[t.confidence]||"conf-medium",c={high:"High confidence",medium:"Medium confidence",low:"Low confidence"}[t.confidence]||"";document.getElementById("predict-result").innerHTML=`
    ...
    <div class="predict-score-grid">
      ${w.map(l=>{const p=t.predicted_scores[l.key];return`<div class="predict-score-cell">
    ...
    ${o.length>0?`
      ...
      ${o.slice(0,5).map(l=>{const p=(s-l.total).toFixed(1),f=p>0?"+":"";return`<div class="predict-comp-row" onclick="openModal(${y.indexOf(l)})">
  ...
  `}function Vt(){Q&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=Q.title,D(()=>Promise.resolve().then(()=>mo),void 0).then(t=>{$e?.predicted_scores&&t.prefillWithPrediction($e.predicted_scores),t.liveSearch(Q.title)}))},100))}let te="all",Xe="focused",W=[],T=0,S={},A={},ne=[];const Gt={focused:15,thorough:30,deep:50},qe=8;function Jt(e){te=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function Kt(e){Xe=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Qt(e,t){const o=[];(e==="all"?w.map(a=>a.key):[e]).forEach(a=>{const r=y.filter(c=>c.scores[a]!=null).sort((c,l)=>c.scores[a]-l.scores[a]);for(let c=0;c<r.length-1;c++)for(let l=c+1;l<r.length;l++){const p=Math.abs(r[c].scores[a]-r[l].scores[a]);if(p<=8)o.push({a:r[c],b:r[l],catKey:a,diff:p});else break}}),o.sort((a,r)=>a.diff-r.diff);const n=new Set,s=[];for(const a of o){const r=[a.a.title,a.b.title,a.catKey].join("|");n.has(r)||(n.add(r),s.push(a))}return s.sort(()=>Math.random()-.5).slice(0,t)}function Xt(){const e=Gt[Xe];if(W=Qt(te,e),W.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}T=0,S={},A={},ne=[],y.forEach(t=>{A[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=te==="all"?"All categories":w.find(t=>t.key===te)?.label||te,Ce()}function Ce(){if(T>=W.length){Zt();return}const{a:e,b:t,catKey:o}=W[T],i=W.length,n=Math.round(T/i*100);document.getElementById("cal-progress-label").textContent=`${T+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=n+"%";const s=w.find(c=>c.key===o)?.label||o;A[e.title]?.[o]??e.scores[o],A[t.title]?.[o]??t.scores[o];function a(c,l){const p=c.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${c.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
  ...
  `}window.undoCalChoice=function(){if(ne.length===0)return;const e=ne.pop();T=e.idx,A=e.tempScores,S=e.deltas,Ce()};window.calChoose=function(e){if(ne.push({idx:T,tempScores:JSON.parse(JSON.stringify(A)),deltas:JSON.parse(JSON.stringify(S))}),e!=="skip"){const{a:t,b:o,catKey:i}=W[T],n=A[t.title]?.[i]??t.scores[i],s=A[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(s-n)/40)),r=1-a,c=e==="a"?1:0,l=1-c,p=Math.round(Math.min(100,Math.max(1,n+qe*(c-a)))),f=Math.round(Math.min(100,Math.max(1,s+qe*(l-r))));if(S[t.title]||(S[t.title]={}),S[o.title]||(S[o.title]={}),p!==n){const m=S[t.title][i]?.old??n;S[t.title][i]={old:m,new:p},A[t.title][i]=p}if(f!==s){const m=S[o.title][i]?.old??s;S[o.title][i]={old:m,new:f},A[o.title][i]=f}const b=document.getElementById(`cal-card-${e}`),g=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);b&&(b.style.opacity="1"),g&&(g.style.opacity="0.35",g.style.transform="scale(0.97)")}T++,setTimeout(()=>Ce(),e==="skip"?0:140)};function Zt(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(S).flatMap(([o,i])=>Object.entries(i).map(([n,{old:s,new:a}])=>({title:o,catKey:n,old:s,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
    ...
    </div>`}).join(""),w.forEach(t=>{u.scores[t.key]=se?.[t.key]??u.scores[t.key]??50})}window.selectAnchor=function(e,t,o){o.closest(".anchor-row").querySelectorAll(".anchor-film").forEach(s=>s.classList.remove("selected")),o.classList.add("selected");const i=u.scores[e]??50,n=Math.round((i+t)/2);document.getElementById("slider_"+e).value=n,updateSlider(e,n)};window.updateSlider=function(e,t){t=parseInt(t),u.scores[e]=t,document.getElementById("sliderVal_"+e).textContent=t,document.getElementById("sliderDesc_"+e).textContent=V(t)};function ct(){co(),de(3)}let F=[],P=0,ae=[];function co(){F=[],ae=[],w.forEach(e=>{const t=u.scores[e.key];if(!t)return;y.filter(i=>i.scores[e.key]!=null&&Math.abs(i.scores[e.key]-t)<=3).sort((i,n)=>Math.abs(i.scores[e.key]-t)-Math.abs(n.scores[e.key]-t)).slice(0,1).forEach(i=>F.push({cat:e,film:i}))}),F=F.slice(0,6),P=0,xe()}function xe(){const e=document.getElementById("hthContainer");if(F.length===0||P>=F.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:var(--dim);font-style:italic">
      No close comparisons needed — your scores are clearly differentiated. Click Continue.
    </div>`;return}const{cat:t,film:o}=F[P],i=u.scores[t.key];e.innerHTML=`
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function ft(e,t){const o=w.map(n=>({key:n.key,val:parseFloat(document.getElementById("awval_"+n.key)?.value)||1})),i=Math.max(...o.map(n=>n.val));o.forEach(n=>{const s=document.getElementById("awbar_"+n.key);s&&(s.style.width=Math.round(n.val/i*100)+"%")})}function uo(){if(!x||!x.archetype)return;const e=Z[x.archetype]?.weights;e&&(w.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),ft())}function yo(){const e={};w.forEach(t=>{const o=parseFloat(document.getElementById("awval_"+t.key)?.value);e[t.key]=isNaN(o)||o<1?1:Math.min(10,o)}),x.weights=e,D(()=>Promise.resolve().then(()=>Ve),void 0).then(t=>t.saveUserLocally()),le(),q(),U(),ut()}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function ut(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}const C=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],yt={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},go={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function vo(e,t,o=220){const i=C.length,n=o/2,s=o/2,a=o*.36,r=$=>$/i*Math.PI*2-Math.PI/2,c=($,_)=>({x:n+a*_*Math.cos(r($)),y:s+a*_*Math.sin(r($))}),l=[.25,.5,.75,1].map($=>`<polygon points="${C.map((M,K)=>`${c(K,$).x},${c(K,$).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),p=C.map(($,_)=>{const M=c(_,1);return`<line x1="${n}" y1="${s}" x2="${M.x}" y2="${M.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),f=Math.max(...C.map($=>e[$]||1)),g=`<polygon points="${C.map(($,_)=>{const M=c(_,(e[$]||1)/f);return`${M.x},${M.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let m="";if(t){const $=Math.max(...C.map(M=>t[M]||1));m=`<polygon points="${C.map((M,K)=>{const Le=c(K,(t[M]||1)/$);return`${Le.x},${Le.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const d=C.map(($,_)=>{const M=c(_,(e[$]||1)/f);return`<circle cx="${M.x}" cy="${M.y}" r="2.5" fill="var(--blue)"/>`}).join(""),v=22,k=C.map(($,_)=>{const M=c(_,1+v/a),K=M.x<n-5?"end":M.x>n+5?"start":"middle";return`<text x="${M.x}" y="${M.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${K}" dominant-baseline="middle">${go[$]}</text>`}).join(""),E=36;return`<svg width="${o+E*2}" height="${o+E*2}" viewBox="${-E} ${-E} ${o+E*2} ${o+E*2}" style="overflow:visible;display:block">
    ${l}${p}${m}${g}${d}${k}
  ...
  `}function Te(){const e=document.getElementById("profileContent");if(!e)return;const t=x;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=Z[t.archetype]||{},i=t.weights||{},n=o.weights||null,s=y,a=C.map(l=>{const p=s.filter(f=>f.scores?.[l]!=null);return{c:l,avg:p.length?p.reduce((f,b)=>f+b.scores[l],0)/p.length:0}}),r=s.length?[...a].sort((l,p)=>p.avg-l.avg)[0]:null,c=s.length?(s.reduce((l,p)=>l+p.total,0)/s.length).toFixed(1):"—";e.innerHTML=`
