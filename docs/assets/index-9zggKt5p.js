(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const $=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let u=[],w=null;function le(e){w=e}function ce(e){u.length=0,e.forEach(t=>u.push(t))}const mt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[0,"Unwatchable"]];function F(e){if(e>=90&&e===Math.max(...u.map(t=>t.total)))return"No better exists";for(const[t,o]of mt)if(e>=t)return o;return"Unwatchable"}function Y(e){let t=0,o=0;for(const i of $)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function te(){u.forEach(e=>{e.total=Y(e.scores)})}function P(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function oe(){if(!w||!w.weights)return;const e=w.weights;$.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),te()}let B={key:"total",dir:"desc"},be="grid";const ft=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Exec"},{key:"acting",label:"Acting"},{key:"production",label:"Prod"},{key:"enjoyability",label:"Enjoy"},{key:"rewatchability",label:"Rewatch"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Unique"}];function ut(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function yt(){const{key:e,dir:t}=B;return e==="rank"||e==="total"?[...u].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...u].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...u].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Ae(e){be=e,L()}function Te(e){B.key===e?B.dir=B.dir==="desc"?"asc":"desc":(B.key=e,B.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=B.dir==="desc"?"↓":"↑")}L()}function L(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(u.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    ${e.map((s,a)=>{const l=n==="total"?s.total:s.scores?.[n]??null,d=l!=null?n==="total"?(Math.round(l*10)/10).toFixed(1):l:"—",p=ut(l),r=s.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${s.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${u.indexOf(s)})">
        <div class="film-card-poster-wrap">
          ${r}
          <div class="film-card-rank">${a+1}</div>
          <div class="film-card-score ${p}">${d}</div>
        </div>
  ...
  </div>`}function gt(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=Le("table"));const n=[...u].sort((a,l)=>l.total-a.total),s=new Map(n.map((a,l)=>[a.title,l+1]));t.innerHTML=e.map(a=>{const l=a.scores,d=s.get(a.title),p=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",r=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${u.indexOf(a)})">
      ...
      <div class="film-total">${p}</div>
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;min-width:60px">
          <div class="breakdown-val ${P(m||50)}" id="modal-edit-val-${f.key}">${m||50}</div>
          <div style="font-family:'DM Mono',monospace;font-size:9px;color:var(--dim);text-align:right;margin-top:2px;white-space:nowrap" id="modal-edit-lbl-${f.key}">${ye(m||50)}</div>
        </div>
        <div class="breakdown-wt">×${f.weight}</div>
      </div>`:`<div class="breakdown-row">
      <div class="breakdown-cat">${f.label}</div>
      <div class="breakdown-bar-wrap"><div class="breakdown-bar" style="width:${m||0}%"></div></div>
      <div class="breakdown-val ${m?P(m):""}">${m??"—"}</div>
      <div class="breakdown-wt">×${f.weight}</div>
    ...
    <div style="display:flex;align-items:baseline;gap:12px;margin-bottom:8px">
      ...
      <span style="font-family:'DM Mono',monospace;font-size:12px;color:var(--dim)" id="modal-total-label">${F(v)}</span>
    </div>
    <div style="margin-bottom:20px">
    ...
    ${!z&&n.length>0?`<div class="compare-section">
      ...
      ${n.map(f=>{const m=(f.total-t.total).toFixed(2),g=m>0?"+":"";return`<div class="compare-film" style="cursor:pointer" onclick="closeModal();openModal(${u.indexOf(f)})">
  ...
  `}function Ct(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(m=>m.classList.remove("active")),document.getElementById("explore").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(m=>m.classList.remove("active")),document.querySelectorAll(".nav-btn")[1].classList.add("active"),window.scrollTo(0,0),document.getElementById("exploreContent").scrollTop=0;const o=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":"companies",i=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":"Company",n=u.filter(m=>e==="director"?(m.director||"").split(",").map(g=>g.trim()).includes(t):e==="writer"?(m.writer||"").split(",").map(g=>g.trim()).includes(t):e==="actor"?(m.cast||"").split(",").map(g=>g.trim()).includes(t):e==="company"?(m.productionCompanies||"").split(",").map(g=>g.trim()).includes(t):!1).sort((m,g)=>g.total-m.total);if(n.length===0){fe();return}const s=qe(o),a=s.findIndex(m=>m.name===t)+1,l=s.length,d=s.find(m=>m.name===t),p=d?d.avg.toFixed(1):(n.reduce((m,g)=>m+g.total,0)/n.length).toFixed(1),r=n[0],c={};$.forEach(m=>{const g=s.filter(x=>x.catAvgs[m.key]!=null).sort((x,M)=>M.catAvgs[m.key]-x.catAvgs[m.key]),k=g.findIndex(x=>x.name===t)+1;c[m.key]=k>0?{rank:k,total:g.length}:null});const v=$.map(m=>{const g=n.filter(k=>k.scores[m.key]!=null).map(k=>k.scores[m.key]);return{...m,avg:g.length?parseFloat((g.reduce((k,x)=>k+x,0)/g.length).toFixed(1)):null}}).filter(m=>m.avg!=null).sort((m,g)=>g.avg-m.avg),S=v[0],f=v[v.length-1];document.getElementById("exploreContent").innerHTML=`
    <div style="max-width:960px">
      ...
      <div class="explore-stat-row">
        <div class="explore-stat">
          <div class="explore-stat-val">${p}</div>
      ...
      ${v.length>0?`
        ...
        <div class="explore-cat-breakdown">
          ${v.map(m=>{const g=c[m.key];return`
            <div class="explore-cat-cell">
              <div class="explore-cat-cell-label">${m.label}</div>
              <div class="explore-cat-cell-val ${P(m.avg)}">${m.avg.toFixed(1)}</div>
      ...
      ${n.map((m,g)=>{const k=m.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${m.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',x=m.total!=null?(Math.round(m.total*10)/10).toFixed(1):"—";return`
        <div class="film-row" onclick="openModal(${u.indexOf(m)})" style="cursor:pointer">
  ...
  `}const ve="f5a446a5f70a9f6a16a8ddd052c121f2",ge="https://api.themoviedb.org/3",Dt="https://ledger-proxy.noahparikhcott.workers.dev";let De=null,V=null;function Ne(){document.getElementById("predict-search").value="",document.getElementById("predict-search-results").innerHTML="",document.getElementById("predict-result").innerHTML="",V=null,setTimeout(()=>document.getElementById("predict-search")?.focus(),50)}function _t(){clearTimeout(De),De=setTimeout(He,500)}async function He(){const e=document.getElementById("predict-search").value.trim();if(!e||e.length<2)return;const t=document.getElementById("predict-search-results");t.innerHTML='<div class="tmdb-loading">Searching…</div>';try{const n=((await(await fetch(`${ge}/search/movie?api_key=${ve}&query=${encodeURIComponent(e)}&language=en-US&page=1`)).json()).results||[]).slice(0,5);if(!n.length){t.innerHTML='<div class="tmdb-error">No results found.</div>';return}const s=new Set(u.map(a=>a.title.toLowerCase()));t.innerHTML=n.map(a=>{const l=a.release_date?.slice(0,4)||"",d=a.poster_path?`<img class="tmdb-result-poster" src="https://image.tmdb.org/t/p/w92${a.poster_path}">`:'<div class="tmdb-result-poster-placeholder">no img</div>',p=s.has(a.title.toLowerCase());return`<div class="tmdb-result ${p?"opacity-50":""}" onclick="${p?"":`predictSelectFilm(${a.id}, '${a.title.replace(/'/g,"\\'")}', '${l}')`}" style="${p?"opacity:0.4;cursor:default":""}">
    ...
    </div>`;let i={},n={};try{const[c,h]=await Promise.all([fetch(`${ge}/movie/${e}?api_key=${ve}`),fetch(`${ge}/movie/${e}/credits?api_key=${ve}`)]);i=await c.json(),n=await h.json()}catch{}const s=(n.crew||[]).filter(c=>c.job==="Director").map(c=>c.name).join(", "),a=(n.crew||[]).filter(c=>["Screenplay","Writer","Story"].includes(c.job)).map(c=>c.name).slice(0,2).join(", "),l=(n.cast||[]).slice(0,8).map(c=>c.name).join(", "),d=(i.genres||[]).map(c=>c.name).join(", "),p=i.overview||"",r=i.poster_path||null;V={tmdbId:e,title:t,year:o,director:s,writer:a,cast:l,genres:d,overview:p,poster:r},await Lt(V)}function At(){const e=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],t={};e.forEach(a=>{const l=u.filter(r=>r.scores[a]!=null).map(r=>r.scores[a]);if(!l.length){t[a]={mean:70,std:10,min:0,max:100};return}const d=l.reduce((r,c)=>r+c,0)/l.length,p=Math.sqrt(l.reduce((r,c)=>r+(c-d)**2,0)/l.length);t[a]={mean:Math.round(d*10)/10,std:Math.round(p*10)/10,min:Math.min(...l),max:Math.max(...l)}});const o=[...u].sort((a,l)=>l.total-a.total),i=o.slice(0,10).map(a=>`${a.title} (${a.total})`).join(", "),n=o.slice(-5).map(a=>`${a.title} (${a.total})`).join(", "),s=$.map(a=>`${a.label}×${a.weight}`).join(", ");return{stats:t,top10:i,bottom5:n,weightStr:s,archetype:w?.archetype,archetypeSecondary:w?.archetype_secondary,totalFilms:u.length}}function Tt(e){const t=(e.director||"").split(",").map(i=>i.trim()).filter(Boolean),o=(e.cast||"").split(",").map(i=>i.trim()).filter(Boolean);return u.filter(i=>{const n=(i.director||"").split(",").map(a=>a.trim()),s=(i.cast||"").split(",").map(a=>a.trim());return t.some(a=>n.includes(a))||o.some(a=>s.includes(a))}).sort((i,n)=>n.total-i.total).slice(0,8)}async function Lt(e){const t=At(),o=Tt(e),i=o.length?o.map(l=>`- ${l.title} (${l.year||""}): total=${l.total}, plot=${l.scores.plot}, execution=${l.scores.execution}, acting=${l.scores.acting}, production=${l.scores.production}, enjoyability=${l.scores.enjoyability}, rewatchability=${l.scores.rewatchability}, ending=${l.scores.ending}, uniqueness=${l.scores.uniqueness}`).join(`
...
Respond with this exact JSON structure:
{
  ...
  "key_comparables": ["<film title>", "<film title>"]
}`;try{const r=((await(await fetch(Dt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system:s,messages:[{role:"user",content:a}]})})).json()).content?.[0]?.text||"").replace(/```json|```/g,"").trim(),c=JSON.parse(r);zt(e,c,o)}catch(l){document.getElementById("predict-result").innerHTML=`
      <div class="tmdb-error">Prediction failed: ${l.message}. Check that the proxy is running and your API key is valid.</div>`}}function zt(e,t,o){let i=0,n=0;$.forEach(p=>{const r=t.predicted_scores[p.key];r!=null&&(i+=r*p.weight,n+=p.weight)});const s=n>0?Math.round(i/n*100)/100:0,a=e.poster?`<img class="predict-poster" src="https://image.tmdb.org/t/p/w185${e.poster}" alt="${e.title}">`:`<div class="predict-poster-placeholder">${e.title}</div>`,l={high:"conf-high",medium:"conf-medium",low:"conf-low"}[t.confidence]||"conf-medium",d={high:"High confidence",medium:"Medium confidence",low:"Low confidence"}[t.confidence]||"";document.getElementById("predict-result").innerHTML=`
    ...
    <div class="predict-score-grid">
      ${$.map(p=>{const r=t.predicted_scores[p.key];return`<div class="predict-score-cell">
    ...
    ${o.length>0?`
      ...
      ${o.slice(0,5).map(p=>{const r=(s-p.total).toFixed(1),c=r>0?"+":"";return`<div class="predict-comp-row" onclick="openModal(${u.indexOf(p)})">
  ...
  `}function jt(){V&&(document.querySelectorAll(".screen").forEach(e=>e.classList.remove("active")),document.getElementById("add").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(e=>e.classList.remove("active")),document.querySelector('.nav-btn[onclick*="add"]').classList.add("active"),setTimeout(()=>{const e=document.getElementById("f-search");e&&(e.value=V.title,_(()=>Promise.resolve().then(()=>eo),void 0).then(t=>t.liveSearch(V.title)))},100))}let X="all",Fe="focused",N=[],q=0,C={},j={};const Pt={focused:15,thorough:30,deep:50},_e=8;function Ot(e){X=e,document.querySelectorAll('[id^="calcat_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calcat_"+e).classList.add("active")}function qt(e){Fe=e,document.querySelectorAll('[id^="calint_"]').forEach(t=>t.classList.remove("active")),document.getElementById("calint_"+e).classList.add("active")}function Rt(e,t){const o=[];(e==="all"?$.map(a=>a.key):[e]).forEach(a=>{const l=u.filter(d=>d.scores[a]!=null).sort((d,p)=>d.scores[a]-p.scores[a]);for(let d=0;d<l.length-1;d++)for(let p=d+1;p<l.length;p++){const r=Math.abs(l[d].scores[a]-l[p].scores[a]);if(r<=8)o.push({a:l[d],b:l[p],catKey:a,diff:r});else break}}),o.sort((a,l)=>a.diff-l.diff);const n=new Set,s=[];for(const a of o){const l=[a.a.title,a.b.title,a.catKey].join("|");n.has(l)||(n.add(l),s.push(a))}return s.sort(()=>Math.random()-.5).slice(0,t)}function Nt(){const e=Pt[Fe];if(N=Rt(X,e),N.length===0){alert("Not enough films with close scores to calibrate. Try a different category or add more films.");return}q=0,C={},j={},u.forEach(t=>{j[t.title]={...t.scores}}),document.getElementById("cal-setup").style.display="none",document.getElementById("cal-matchups").style.display="block",document.getElementById("cal-cat-label").textContent=X==="all"?"All categories":$.find(t=>t.key===X)?.label||X,Ue()}function Ht(e){return e>=90?"#C4922A":e>=80?"#1F4A2A":e>=70?"#4A5830":e>=60?"#6B4820":"rgba(12,11,9,0.65)"}function Ue(){if(q>=N.length){Ft();return}const{a:e,b:t,catKey:o}=N[q],i=N.length,n=Math.round(q/i*100);document.getElementById("cal-progress-label").textContent=`${q+1} / ${i}`,document.getElementById("cal-progress-bar").style.width=n+"%";const s=$.find(p=>p.key===o)?.label||o,a=j[e.title]?.[o]??e.scores[o],l=j[t.title]?.[o]??t.scores[o];function d(p,r,c){const h=p.poster?`<img style="width:100%;height:100%;object-fit:cover;display:block" src="https://image.tmdb.org/t/p/w342${p.poster}" alt="" loading="lazy">`:'<div style="width:100%;height:100%;background:var(--deep-cream)"></div>';return`
    ...
    <div style="font-family:'DM Mono',monospace;font-size:10px;letter-spacing:2px;text-transform:uppercase;color:var(--dim);text-align:center;margin-bottom:24px">
      Better <span style="color:var(--ink)">${s}</span>?
    </div>
  ...
  `}window.calChoose=function(e){if(e!=="skip"){const{a:t,b:o,catKey:i}=N[q],n=j[t.title]?.[i]??t.scores[i],s=j[o.title]?.[i]??o.scores[i],a=1/(1+Math.pow(10,(s-n)/40)),l=1-a,d=e==="a"?1:0,p=1-d,r=Math.round(Math.min(100,Math.max(1,n+_e*(d-a)))),c=Math.round(Math.min(100,Math.max(1,s+_e*(p-l))));if(C[t.title]||(C[t.title]={}),C[o.title]||(C[o.title]={}),r!==n){const S=C[t.title][i]?.old??n;C[t.title][i]={old:S,new:r},j[t.title][i]=r}if(c!==s){const S=C[o.title][i]?.old??s;C[o.title][i]={old:S,new:c},j[o.title][i]=c}const h=document.getElementById(`cal-card-${e}`),v=document.getElementById(`cal-card-${e==="a"?"b":"a"}`);h&&(h.style.opacity="1"),v&&(v.style.opacity="0.35",v.style.transform="scale(0.97)")}q++,setTimeout(()=>Ue(),e==="skip"?0:140)};function Ft(){document.getElementById("cal-matchups").style.display="none",document.getElementById("cal-review").style.display="block";const e=Object.entries(C).flatMap(([o,i])=>Object.entries(i).map(([n,{old:s,new:a}])=>({title:o,catKey:n,old:s,new:a}))).filter(o=>o.old!==o.new).sort((o,i)=>Math.abs(i.new-i.old)-Math.abs(o.new-o.old));if(e.length===0){document.getElementById("cal-review-header").innerHTML=`
    ...
    <div style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Uncheck anything you want to keep. Nothing changes until you apply.</div>`,document.getElementById("cal-apply-btn").style.display="";const t=Object.fromEntries($.map(o=>[o.key,o.label]));document.getElementById("cal-diff-list").innerHTML=e.map((o,i)=>{const n=o.new>o.old?"up":"down",s=n==="up"?"↑":"↓",a=n==="up"?"var(--green)":"var(--red)",l=u.find(d=>d.title===o.title);return`<div style="display:flex;align-items:center;gap:16px;padding:14px 0;border-bottom:1px solid var(--rule)">
      ...
      <div style="display:flex;align-items:center;gap:10px;flex-shrink:0">
        ...
        <span style="font-family:'DM Mono',monospace;font-size:16px;color:${a}">${s}</span>
    ...
    `}else if(b==="reveal"){const t=Wt(G);A=t,A._slug||(A._slug=ae.toLowerCase().replace(/[^a-z0-9]/g,"-")+"-"+Math.floor(Math.random()*9e3+1e3));const o=K[t.primary],i=o.palette||"#3d5a80";e.innerHTML=`
  ...
  </div>`}function Ke(e){D[e]&&(D[e].checked=!D[e].checked);const t=document.getElementById("castItem_"+e),o=D[e].checked;t.className="cast-item "+(o?"checked":"unchecked"),t.querySelector(".cast-check").textContent=o?"✓":""}async function Qe(){const e=document.getElementById("moreCastBtn");e.textContent="Loading…",e.disabled=!0,Z.slice(8,20).forEach(i=>{D[i.id]||(D[i.id]={actor:i,checked:!1})});const o=Z.slice(0,20);Je(o),e.textContent="+ More cast",e.disabled=!1,Z.length<=20&&(e.style.display="none")}function Jt(e){document.getElementById("curate-companies").innerHTML=`<div class="company-chips">
    ${e.map(t=>`
  ...
  </div>`}function Xe(e){H[e].checked=!H[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(H[e].checked?"checked":"unchecked")}function Ze(){document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function et(){const e=y._allDirectors||[],t=y._allWriters||[],o=Object.values(D).filter(n=>n.checked).map(n=>n.actor.name),i=Object.values(H).filter(n=>n.checked).map(n=>n.company.name);y.title=y._tmdbDetail.title,y.director=e.join(", "),y.writer=t.join(", "),y.cast=o.join(", "),y.productionCompanies=i.join(", "),Qt(),ne(2)}function Kt(e){const t=[...u].filter(i=>i.scores[e]!=null).sort((i,n)=>n.scores[e]-i.scores[e]),o=t.length;return[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean)}function Qt(){const e=document.getElementById("calibrationCategories");e.innerHTML=$.map(t=>{const o=Kt(t.key),i=y.scores[t.key]||75;return`<div class="category-section" id="catSection_${t.key}">
  ...
  `}window.hthChoice=function(e,t,o){const i=y.scores[t];e==="new"&&i<=o?y.scores[t]=o+1:e==="existing"&&i>=o&&(y.scores[t]=o-1),J++,ke()};window.hthSkip=function(){J++,ke()};function ot(){Zt(),ne(4)}function Zt(){const e=Y(y.scores);y.total=e;const t=[...u,y].sort((i,n)=>n.total-i.total),o=t.indexOf(y)+1;document.getElementById("resultCard").innerHTML=`
    <div style="font-family:'DM Mono',monospace;font-size:10px;color:var(--dim);text-transform:uppercase;letter-spacing:1.5px;margin-bottom:6px">
  ...
  `,document.getElementById("archetypeModal").classList.add("open")}function st(e,t){const o=$.map(n=>({key:n.key,val:parseFloat(document.getElementById("awval_"+n.key)?.value)||1})),i=Math.max(...o.map(n=>n.val));o.forEach(n=>{const s=document.getElementById("awbar_"+n.key);s&&(s.style.width=Math.round(n.val/i*100)+"%")})}function oo(){if(!w||!w.archetype)return;const e=K[w.archetype]?.weights;e&&($.forEach(t=>{const o=document.getElementById("awval_"+t.key);o&&(o.value=e[t.key]||1)}),st())}function io(){const e={};$.forEach(t=>{const o=parseFloat(document.getElementById("awval_"+t.key)?.value);e[t.key]=isNaN(o)||o<1?1:Math.min(10,o)}),w.weights=e,_(()=>Promise.resolve().then(()=>Oe),void 0).then(t=>t.saveUserLocally()),oe(),L(),U(),at()}window.logOutUser=function(){confirm("Sign out? Your data is saved to the cloud under your username.")&&(localStorage.clear(),location.reload())};function at(e){(!e||e.target===document.getElementById("archetypeModal"))&&document.getElementById("archetypeModal").classList.remove("open")}const I=["plot","execution","acting","production","enjoyability","rewatchability","ending","uniqueness"],rt={plot:"Plot",execution:"Execution",acting:"Acting",production:"Production",enjoyability:"Enjoyability",rewatchability:"Rewatchability",ending:"Ending",uniqueness:"Uniqueness"},no={plot:"Plot",execution:"Exec",acting:"Acting",production:"Prod",enjoyability:"Enjoy",rewatchability:"Rewatch",ending:"Ending",uniqueness:"Unique"};function so(e,t,o=220){const i=I.length,n=o/2,s=o/2,a=o*.36,l=x=>x/i*Math.PI*2-Math.PI/2,d=(x,M)=>({x:n+a*M*Math.cos(l(x)),y:s+a*M*Math.sin(l(x))}),p=[.25,.5,.75,1].map(x=>`<polygon points="${I.map((E,W)=>`${d(W,x).x},${d(W,x).y}`).join(" ")}" fill="none" stroke="var(--rule)" stroke-width="0.75"/>`).join(""),r=I.map((x,M)=>{const E=d(M,1);return`<line x1="${n}" y1="${s}" x2="${E.x}" y2="${E.y}" stroke="var(--rule)" stroke-width="0.75"/>`}).join(""),c=Math.max(...I.map(x=>e[x]||1)),v=`<polygon points="${I.map((x,M)=>{const E=d(M,(e[x]||1)/c);return`${E.x},${E.y}`}).join(" ")}" fill="var(--blue)" fill-opacity="0.12" stroke="var(--blue)" stroke-width="1.5" stroke-linejoin="round"/>`;let S="";if(t){const x=Math.max(...I.map(E=>t[E]||1));S=`<polygon points="${I.map((E,W)=>{const Ie=d(W,(t[E]||1)/x);return`${Ie.x},${Ie.y}`}).join(" ")}" fill="none" stroke="var(--dim)" stroke-width="0.75" stroke-dasharray="3,3" opacity="0.45"/>`}const f=I.map((x,M)=>{const E=d(M,(e[x]||1)/c);return`<circle cx="${E.x}" cy="${E.y}" r="2.5" fill="var(--blue)"/>`}).join(""),m=22,g=I.map((x,M)=>{const E=d(M,1+m/a),W=E.x<n-5?"end":E.x>n+5?"start":"middle";return`<text x="${E.x}" y="${E.y}" font-family="'DM Mono',monospace" font-size="8.5" fill="var(--dim)" text-anchor="${W}" dominant-baseline="middle">${no[x]}</text>`}).join(""),k=36;return`<svg width="${o+k*2}" height="${o+k*2}" viewBox="${-k} ${-k} ${o+k*2} ${o+k*2}" style="overflow:visible;display:block">
    ${p}${r}${S}${v}${f}${g}
  </svg>`}function ao(e){return e.length?I.map(t=>{const o=e.filter(a=>a.scores?.[t]!=null),i=o.length?o.reduce((a,l)=>a+l.scores[t],0)/o.length:null,n=i!=null?i.toFixed(1):"—",s=i??0;return`<div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
      ...
      <div style="display:flex;align-items:center;gap:16px;border-bottom:1px solid var(--rule);min-height:63px;cursor:pointer;transition:background 0.12s"
        ...
        <div style="font-family:'Playfair Display',serif;font-style:italic;font-weight:900;font-size:18px;color:white;padding:4px 11px 3px;background:${ro(o.total)};border-radius:4px;flex-shrink:0">${s}</div>
      </div>
    `}).join(""):`<p style="font-family:'DM Sans',sans-serif;font-size:14px;color:var(--dim)">Rate some films to see your signature picks.</p>`}function co(e,t){const o=[...t].sort((s,a)=>a.total-s.total).slice(0,3),i=t.length?(t.reduce((s,a)=>s+a.total,0)/t.length).toFixed(1):"—",n=K[e.archetype]||{};return`
  ...
  `}function Me(){const e=document.getElementById("profileContent");if(!e)return;const t=w;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=K[t.archetype]||{},i=t.weights||{},n=o.weights||null,s=u,a=I.map(p=>{const r=s.filter(c=>c.scores?.[p]!=null);return{c:p,avg:r.length?r.reduce((c,h)=>c+h.scores[p],0)/r.length:0}}),l=s.length?[...a].sort((p,r)=>r.avg-p.avg)[0]:null,d=s.length?(s.reduce((p,r)=>p+r.total,0)/s.length).toFixed(1):"—";e.innerHTML=`
