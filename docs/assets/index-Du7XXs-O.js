(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const $=[{key:"plot",label:"Plot",weight:3,question:"How strong, original, and well-constructed is the story?"},{key:"execution",label:"Execution",weight:3,question:"Direction, cinematography, pacing — how well is it made?"},{key:"acting",label:"Acting",weight:2,question:"How effective is the overall performance?"},{key:"production",label:"Production",weight:1,question:"Score, production design, costume — the craft around the film."},{key:"enjoyability",label:"Enjoyability",weight:4,question:"The most honest question: how much did you actually enjoy it?"},{key:"rewatchability",label:"Rewatchability",weight:1,question:"Would you sit down and watch this again? How eagerly?"},{key:"ending",label:"Ending",weight:1,question:"How satisfying, earned, and well-executed is the conclusion?"},{key:"uniqueness",label:"Uniqueness",weight:2,question:"Does this feel genuinely singular? Could only this film exist this way?"}];let u=[],w=null;function pe(e){w=e}function me(e){u.length=0,e.forEach(t=>u.push(t))}const vt=[[90,"An all-time favorite"],[85,"Really quite exceptional"],[80,"Excellent"],[75,"Well above average"],[70,"Great"],[65,"Very good"],[60,"A cut above"],[55,"Good"],[50,"Solid"],[45,"Not bad"],[40,"Sub-par"],[35,"Multiple flaws"],[30,"Poor"],[25,"Bad"],[20,"Wouldn't watch by choice"],[0,"Unwatchable"]];function U(e){if(e>=90&&e===Math.max(...u.map(t=>t.total)))return"No better exists";for(const[t,o]of vt)if(e>=t)return o;return"Unwatchable"}function Y(e){let t=0,o=0;for(const i of $)e[i.key]!=null&&(t+=e[i.key]*i.weight,o+=i.weight);return o>0?Math.round(t/o*100)/100:0}function ne(){u.forEach(e=>{e.total=Y(e.scores)})}function q(e){return e>=90?"s90":e>=80?"s80":e>=70?"s70":e>=60?"s60":e>=50?"s50":e>=40?"s40":"s30"}function se(){if(!w||!w.weights)return;const e=w.weights;$.forEach(t=>{e[t.key]!=null&&(t.weight=e[t.key])}),ne()}let A={key:"total",dir:"desc"},Ee="grid";const gt=[{key:"total",label:"Total"},{key:"plot",label:"Plot"},{key:"execution",label:"Exec"},{key:"acting",label:"Acting"},{key:"production",label:"Prod"},{key:"enjoyability",label:"Enjoy"},{key:"rewatchability",label:"Rewatch"},{key:"ending",label:"Ending"},{key:"uniqueness",label:"Unique"}];function ht(e){return e==null?"badge-dim":e>=90?"badge-gold":e>=80?"badge-green":e>=70?"badge-olive":e>=60?"badge-amber":"badge-dim"}function xt(){const{key:e,dir:t}=A;return e==="rank"||e==="total"?[...u].sort((o,i)=>t==="desc"?i.total-o.total:o.total-i.total):e==="title"?[...u].sort((o,i)=>t==="desc"?i.title.localeCompare(o.title):o.title.localeCompare(i.title)):[...u].sort((o,i)=>t==="desc"?(i.scores[e]||0)-(o.scores[e]||0):(o.scores[e]||0)-(i.scores[e]||0))}function Pe(e){Ee=e,P()}function Oe(e){A.key===e?A.dir=A.dir==="desc"?"asc":"desc":(A.key=e,A.dir="desc"),document.querySelectorAll(".sort-arrow").forEach(o=>o.classList.remove("active-sort"));const t=document.getElementById("sort-"+e+"-arrow")||document.getElementById("sort-"+e);if(t){const o=t.querySelector?t.querySelector(".sort-arrow"):t;o&&(o.classList.add("active-sort"),o.textContent=A.dir==="desc"?"↓":"↑")}P()}function P(){const e=document.getElementById("filmList"),t=document.getElementById("rankings"),o=document.getElementById("rankings-controls");if(u.length===0){t.classList.add("empty"),t.classList.remove("grid-mode"),document.getElementById("mastheadCount").textContent="0 films ranked",o&&(o.innerHTML=""),e.innerHTML=`
    ...
    `;return}t.classList.remove("empty"),document.getElementById("mastheadCount").textContent=u.length+" films ranked";const i=xt();Ee==="grid"?bt(i,e,o,t):wt(i,e,o,t)}function qe(e){const t=A.key;return`<div class="rankings-toolbar">
    ${Ee==="grid"?`
    ...
    ${e.map((s,a)=>{const l=n==="total"?s.total:s.scores?.[n]??null,p=l!=null?n==="total"?(Math.round(l*10)/10).toFixed(1):l:"—",m=ht(l),r=s.poster?`<img class="film-card-poster" src="https://image.tmdb.org/t/p/w342${s.poster}" alt="" loading="lazy">`:'<div class="film-card-poster-none"></div>';return`<div class="film-card" onclick="openModal(${u.indexOf(s)})">
  ...
  </div>`}function wt(e,t,o,i){i.classList.remove("grid-mode"),o&&(o.innerHTML=qe("table"));const n=[...u].sort((a,l)=>l.total-a.total),s=new Map(n.map((a,l)=>[a.title,l+1]));t.innerHTML=e.map(a=>{const l=a.scores,p=s.get(a.title),m=a.total!=null?(Math.round(a.total*10)/10).toFixed(1):"—",r=a.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${a.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>';return`<div class="film-row" onclick="openModal(${u.indexOf(a)})">
      ...
      <div class="film-total">${m}</div>
        ...
        <div style="display:flex;flex-direction:column;align-items:flex-end;min-width:60px">
          <div class="breakdown-val ${q(y||50)}" id="modal-edit-val-${c.key}">${y||50}</div>
      ...
      <div class="breakdown-val ${y?q(y):""}">${y??"—"}</div>
      <div class="breakdown-wt">×${c.weight}</div>
  ...
  `}function Tt(e,t){document.getElementById("filmModal").classList.remove("open"),document.querySelectorAll(".screen").forEach(c=>c.classList.remove("active")),document.getElementById("explore").classList.add("active"),document.querySelectorAll(".nav-btn").forEach(c=>c.classList.remove("active")),document.querySelectorAll(".nav-btn")[1].classList.add("active"),window.scrollTo(0,0),document.getElementById("exploreContent").scrollTop=0;const o=e==="director"?"directors":e==="writer"?"writers":e==="actor"?"actors":"companies",i=e==="director"?"Director":e==="writer"?"Writer":e==="actor"?"Actor":"Company",n=u.filter(c=>e==="director"?(c.director||"").split(",").map(y=>y.trim()).includes(t):e==="writer"?(c.writer||"").split(",").map(y=>y.trim()).includes(t):e==="actor"?(c.cast||"").split(",").map(y=>y.trim()).includes(t):e==="company"?(c.productionCompanies||"").split(",").map(y=>y.trim()).includes(t):!1).sort((c,y)=>y.total-c.total);if(n.length===0){ve();return}const s=Ue(o),a=s.findIndex(c=>c.name===t)+1,l=s.length,p=s.find(c=>c.name===t),m=p?p.avg.toFixed(1):(n.reduce((c,y)=>c+y.total,0)/n.length).toFixed(1),r=n[0],d={};$.forEach(c=>{const y=s.filter(h=>h.catAvgs[c.key]!=null).sort((h,M)=>M.catAvgs[c.key]-h.catAvgs[c.key]),g=y.findIndex(h=>h.name===t)+1;d[c.key]=g>0?{rank:g,total:y.length}:null});const v=$.map(c=>{const y=n.filter(g=>g.scores[c.key]!=null).map(g=>g.scores[c.key]);return{...c,avg:y.length?parseFloat((y.reduce((g,h)=>g+h,0)/y.length).toFixed(1)):null}}).filter(c=>c.avg!=null).sort((c,y)=>y.avg-c.avg),k=v[0],S=v[v.length-1];document.getElementById("exploreContent").innerHTML=`
    <div style="max-width:960px">
      ...
      ${n.map((c,y)=>{const g=c.poster?`<img class="film-poster-thumb" src="https://image.tmdb.org/t/p/w92${c.poster}" alt="" loading="lazy">`:'<div class="film-poster-none"></div>',h=c.total!=null?(Math.round(c.total*10)/10).toFixed(1):"—";return`
...
Respond with this exact JSON structure:
{
  ...
  </div>`}function ot(e){F[e].checked=!F[e].checked;const t=document.getElementById("companyChip_"+e);t.className="company-chip "+(F[e].checked?"checked":"unchecked")}function it(){oe=null,document.getElementById("tmdb-search-phase").style.display="block",document.getElementById("tmdb-curation-phase").style.display="none",document.getElementById("tmdb-results").innerHTML=""}function nt(){const e=f._allDirectors||[],t=f._allWriters||[],o=Object.values(B).filter(n=>n.checked).map(n=>n.actor.name),i=Object.values(F).filter(n=>n.checked).map(n=>n.company.name);f.title=f._tmdbDetail.title,f.director=e.join(", "),f.writer=t.join(", "),f.cast=o.join(", "),f.productionCompanies=i.join(", "),to(),re(2)}let oe=null;function Zt(e){oe=e}function eo(e){const t=[...u].filter(s=>s.scores[e]!=null).sort((s,a)=>a.scores[e]-s.scores[e]),o=t.length,i=[t[Math.floor(o*.05)],t[Math.floor(o*.25)],t[Math.floor(o*.5)],t[Math.floor(o*.75)],t[Math.floor(o*.95)]].filter(Boolean),n=new Set;return i.filter(s=>n.has(s.title)?!1:(n.add(s.title),!0))}function to(){const e=document.getElementById("calibrationCategories");e.innerHTML=$.map(t=>{const o=eo(t.key),i=oe?.[t.key]??f.scores[t.key]??50;return`<div class="category-section" id="catSection_${t.key}">
  ...
  `}function Ce(){const e=document.getElementById("profileContent");if(!e)return;const t=w;if(!t){e.innerHTML='<p style="color:var(--dim)">Sign in to view your profile.</p>';return}const o=K[t.archetype]||{},i=t.weights||{},n=o.weights||null,s=u,a=D.map(m=>{const r=s.filter(d=>d.scores?.[m]!=null);return{c:m,avg:r.length?r.reduce((d,x)=>d+x.scores[m],0)/r.length:0}}),l=s.length?[...a].sort((m,r)=>r.avg-m.avg)[0]:null,p=s.length?(s.reduce((m,r)=>m+r.total,0)/s.length).toFixed(1):"—";e.innerHTML=`
